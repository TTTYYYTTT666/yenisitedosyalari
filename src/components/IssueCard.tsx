...
export default function IssueCard({ issue }: IssueCardProps) {
    ...
    return (
        <div className={`bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 border-l-4 ${styles.border} rounded-lg p-4 hover:shadow-sm transition-shadow`}>
            <div className="flex items-start justify-between mb-2">
                ...
                <span className={`px-2 py-0.5 rounded text-[11px] font-semibold ${styles.badge} shrink-0`}>

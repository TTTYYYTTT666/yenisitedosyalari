...
export const chevroletCars: Car[] = [
    {
        ...
        issues: [
            ...
            { id: "cruze-4", title: "Boya/Kaporta Kalitesi", description: "İnce boya ve sac kalitesi. Taş çarpma ve çiziklere karşı dayanıksız.", category: "govde", riskLevel: "LOW", affectedKm: "1-2 yıl", repairCost: "3.000 - 10.000 TL (Boya/Rötuş)" },

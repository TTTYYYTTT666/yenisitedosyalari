...
export const cars: Car[] = [
        ...
        issues: [
            {
                ...
                description: "Özellikle 2021 öncesi Euro 6b motorlarda piston segmanlarından kaynaklı yüksek yağ eksiltme (1000km/1L).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "30.000+ km",
                repairCost: "35.000 - 65.000 TL"
            },
            {
                id: "egea-2",
            ...
            {
                id: "egea-3",
                title: "City Modu / Direksiyon",
                description: "Direksiyon kutusu tıkırtısı ve City modu sertleşme sorunu.",
            ...
            {
                id: "egea-4",
                title: "Kapı Fitili Sesi",
                description: "100-110 km/s hızlardan sonra kapılardan gelen ıslık/rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Fitil değişimi / Ek yalıtım"
            },
            {
                id: "egea-5",
                title: "Bagaj Su Alma",
                description: "Stop lambası contalarından ve bagaj havalandırma tapalarından su sızması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Yağmurda",
            ...
            {
                id: "egea-6",
                title: "Radyatör Üst Hortumu (Kronik)",
                description: "Üst hortumun şişmesi ve patlaması riski. Servis aksiyonu ile kelepçe değişimi yapılmalıdır.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
            ...
            },
            {
                ...
                description: "Motor arıza lambasının yanması ve rölanti dalgalanması.",
                category: "motor",
                riskLevel: "LOW",
            ...
            },
            {
                ...
                description: "Atmosferik motor yapısı gereği yokuşlarda ciddi tork yetersizliği.",
                category: "motor",
                riskLevel: "LOW",
    ...
    },
    {
        ...
        issues: [
            {
                id: "egea-m-1",
                title: "DPF (Partikül) Tıkanıklığı",
                description: "Şehir içi kısa mesafe kullanımda DPF doluluğu ve rejenerasyon uyarısı.",
                category: "motor",
                riskLevel: "MEDIUM",
            ...
            {
                id: "egea-m-2",
                title: "Triger Zincir Sesi",
                description: "1.3 MultiJet'lerde zincir uzaması sonucu şakırtı. 120 bin km'yi beklemeden değişmeli.",
                category: "motor",
                riskLevel: "HIGH",
            ...
            },
            {
                ...
                description: "Enjektörlerin işeme yapması sonucu siyah duman ve rölanti dalgalanması.",
                category: "motor",
                riskLevel: "HIGH",
            ...
            },
            {
                ...
                description: "Euro 6d motorlarda AdBlue şamandıra ve pompa arızası.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
            ...
            },
            {
                ...
                description: "Kurum birikmesi sonucu EGR valfinin çalışmaması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
            ...
            {
                id: "egea-yeni-dizel-1",
                title: "Marş Uzaması (Soğukta)",
                description: "Özellikle kışın ısıtma bujileri sağlam olsa bile geç çalışma sorunu.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
            ...
            {
                id: "egea-yeni-dizel-2",
                title: "Vites Geçiş Sertliği",
                description: "Soğuk havalarda 1. ve 2. vitese geçişte zorlanma veya cırtlama.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Soğukken",
                repairCost: "Şanzıman Yağı"
            }
        ],
        pros: [
        ...
        cons: [
            ...
            "AdBlue sorunları (2021 sonrası)",
            "Şehir içinde DPF sorunu"
        ],
        buyingTips: [
            "Zincir sesi var mı dinleyin (Soğuk motor)",
            "Egzozdan kurum atıyor mu bakın",
            "AdBlue deposu değişmiş mi sorun"
        ]
    },
    {
        ...
        issues: [
            {
                ...
                description: "Ön panjur ve kapı kollarındaki kromların erken deformasyonu.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "2-3 Yıl",
                repairCost: "Kozmetik"
            },
            {
                ...
                description: "1.4 Fire motorların genel karakteristiği, 1000 km'de yarım litreye kadar yağ eksiltme.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Sıfır km'den itibaren",
                repairCost: "Yağ Ekleme"
            },
            {
                id: "egea-cross-1",
            ...
            },
            {
                ...
                description: "Bozuk yollarda veya kasislerde ön takımdan gelen 'lokurtu' sesi.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "30.000+ km",
                repairCost: "3.000 - 6.000 TL"
            ...
            {
                id: "egea-cross-6",
                title: "Yokuş Performansı",
                description: "Atmosferik motorun tork yetersizliği nedeniyle dik yokuşlarda bayılma (Karakteristik).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Çözümsüz"
            ...
            {
                id: "egea-cross-4",
                title: "Tavan Çıtası Solması",
                description: "Tavan raylarının güneşten renginin atması (Kozmetik).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "3+ Yıl",
                repairCost: "Kozmetik"
    ...
    },
    {
        ...
        issues: [
            ...
            },
            {
                ...
                description: "Yağın soğutma suyuna karışması (Genleşme kabında tahin kıvamı).",
                category: "motor",
                riskLevel: "CRITICAL",
            ...
            {
                id: "linea-7",
                title: "Turbo Arızası (Ötme)",
                description: "Turbodan ıslık sesi gelmesi ve çekiş düşüklüğü (Manifold contası da olabilir).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "15.000 - 30.000 TL"
            ...
            },
            {
                ...
                description: "Direksiyonu çevirirken gelen 'gırç gırç' sesi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "60.000+ km",
                repairCost: "2.500 - 5.000 TL"
            },
            {
                ...
                description: "Çekiş düşüklüğü ve siyah duman atma.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "Temizlik / İptal"
            },
            {
                id: "linea-9",
                title: "Torpido Çatlaması",
                description: "Yolcu hava yastığı kısmının güneşten çatlaması (Kronik).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "10+ Yıl",
                repairCost: "Kaplama"
        ...
        buyingTips: [
            "EGR iptali yapılmış mı?",
            "Debriyaj pedalını kontrol edin"
        ]
    },
    {
        ...
        issues: [
            {
                id: "doblo-6",
                title: "Vites Geçiş Sorunu",
                description: "Özellikle 1. vitese geçişte zorlanma ve cırtlama (Senkromeç/Dişli aşınması).",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
            ...
            },
            {
                ...
                description: "Şehir içi kullanımda partikül filtresi/EGR tıkanması ve çekiş düşüklüğü.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Şehir içi sürekli",
            ...
            {
                id: "doblo-7",
                title: "Turbo Islık Sesi",
                description: "Turbodan gelen ıslık sesi ve yağ kaçağı (Revizyon gerekebilir).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "15.000 - 30.000 TL"
            },
            {
                ...
                description: "Yük altında çalışan araçlarda arka süspansiyon takozlarından gelen vuruntu.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "4.000 - 8.000 TL"
            ...
            {
                id: "doblo-4",
                title: "Yolcu Airbag Şişmesi",
                description: "Torpido üzerindeki airbag kapağının güneşte şişmesi (Kronik).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Kaplama"
            ...
            {
                id: "doblo-2",
                title: "Intercooler Hortum Patlaması",
                description: "Turbo hortumunun çatlaması sonucu ciddi çekiş kaybı ve 'tıss' sesi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "3.000 - 6.000 TL"
            },
            {
                ...
                description: "Soğuk motor çalışırken enjektörlerden gelen metalik şakırtı sesi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "150.000+ km",
                repairCost: "10.000 - 20.000 TL"
        ...
        pros: [
            "Devasa yükleme alanı",
            "Güçlü 1.6 motor (105/120hp)",
            "Yol tutuş (Bağımsız süspansiyon)"
        ],
        cons: [
            "Arka süspansiyon sert",
            "Rüzgar sesi (Aynalar büyük)"
        ],
        buyingTips: [
            "Turbo hortumlarında yağ kaçağı var mı?",
            "Arka kapı kilitlerini kontrol edin"
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Vites geçişlerinde titreme, kararsızlık veya 'P' moduna almama uyarısı.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
            ...
            },
            {
                ...
                description: "Rölantide veya stop ederken gelen 'şak şak' sesi.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "90.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "passat-2",
                title: "Devirdaim Su Kaçağı",
                description: "Elektronik devirdaim pompasının kilitlenmesi veya su kaçırması (Triger setine zarar verebilir).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "70.000+ km",
            ...
            {
                id: "passat-3",
                title: "Cam Tavan Ses Yapması",
                description: "Panoramik cam tavanın kasislerde gıcırtı yapması (Aşiret paketin kaderi).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
            ...
            {
                id: "passat-4",
                title: "Dizel Partikül Filtresi (DPF)",
                description: "Sürekli düşük devir kullanımda tıkanıklık ve motor arıza lambası.",
                category: "motor",
                riskLevel: "MEDIUM",
            ...
            {
                id: "passat-5",
                title: "Z Rot / Ön Takım",
                description: "Bozuk yollarda ön takımdan gelen lokurtu.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "50.000+ km",
                repairCost: "2.000 - 4.000 TL"
        ...
        cons: [
            ...
            "DSG riskleri",
            "Şehir içi sert süspansiyon (Highline)"
        ],
        buyingTips: [
    ...
    },
    {
        ...
        issues: [
            {
                id: "golf-1",
                title: "DSG Mekatronik Arızası",
                description: "Vites geçişlerinde titreme, kararsızlık veya 'Mekatronik' kart arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                id: "golf-4",
                title: "Aşırı Yağ Tüketimi",
                description: "1.4 TSI 122/140/150 hp motorlarda segman kaynaklı yağ eksiltme.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "Motor Revizyonu"
            },
            {
                ...
                description: "Plastik termostat gövdesinden antifriz kaçağı ve su eksiltme.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "8.000 - 15.000 TL"
            ...
            {
                id: "golf-6",
                title: "Koltuk Aşınması",
                description: "Özellikle Highline 'Alcantara' koltukların yan desteklerinde erken yıpranma.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
            ...
            },
            {
                id: "golf-7",
                title: "Trim Sesleri",
                description: "Sunroof, kapı fitilleri ve gösterge panelinden gelen tıkırtılar.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Yalıtım"
            },
            {
                ...
                description: "Kapıların kilitlenmemesi veya dışarıdan açılmaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "3.500 - 7.000 TL"
            },
            {
                id: "golf-8",
                title: "Turbo Wastegate Sesi",
                description: "Gaza basıp bırakınca turbodan gelen metalik şıngırtı sesi (Zararsız ama rahatsız edici).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
        ...
        buyingTips: [
            "Şanzıman kartı değişmiş mi sorun",
    ...
    },
    {
        ...
        issues: [
            {
                id: "tiguan-1",
                title: "Kangaroo Effect (Silkeleme)",
                description: "Soğuk motorda ilk kalkışta aracın ileri geri silkelemesi (1.5 TSI Evo kronik - Yazılım ile azalır).",
                category: "motor",
                riskLevel: "MEDIUM",
            ...
            },
            {
                id: "tiguan-3",
                title: "DSG Mekatronik Arızası",
                description: "Vites geçişlerinde kararsızlık, titreme ve mekatronik tüp gevşemesi.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 45.000 TL"
            ...
            {
                id: "tiguan-6",
                title: "Panoramik Tavan Su Alma",
                description: "Tavan giderlerinin tıkanması sonucu içeri su sızdırması (Kronik bakım ister).",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Her bakımda",
                repairCost: "Temizlik / Fitil Değişimi"
            },
            {
                id: "tiguan-7",
                title: "Ön Takım Burç Sesi",
                description: "Soğuk havalarda kasis geçişlerinde ön takımdan gelen gıcırtı (Yağlanma gerekir).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kışın",
            ...
            },
            {
                ...
                description: "Ekranın donması, siyah ekran veya Bluetooth bağlantı sorunları.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Değişim"
            ...
            {
                id: "tiguan-4",
                title: "Kapı Fitil Sesleri",
                description: "Bozuk yollarda kapı fitillerinden gelen gıcırtı sesleri (Kronik).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Bakım Spreyi"
            },
            {
                id: "tiguan-8",
                title: "Fren Sesi (Geri Viteste)",
                description: "Geri manevra yaparken frenlerden gelen uğultu sesi.",
                category: "fren",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Balata Değişimi"
            }
        ],
        pros: [
            "Geniş iç hacim",
        ...
        cons: [
            "Yüksek yakıt tüketimi (9-10LT)",
            "Sert süspansiyon"
        ],
        buyingTips: [
            "Soğuk motorla test sürüşü yapın (silkeleme için)",
            "Cam tavanı açıp kapatın"
        ]
    },
    {
        ...
        issues: [
            {
                ...
                description: "Arka C sütununda dalgalanma şeklinde göçük (2016-2018 modellerde kronik).",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik",
                repairCost: "5.000 - 10.000 TL (Düzeltme)"
            },
            {
                id: "civic-2",
                title: "Direksiyon Kutusu Sesi",
                description: "Bozuk yollarda direksiyon kutusundan gelen tıkırtı sesi (Kronik boşluk).",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "40.000+ km",
            ...
            {
                id: "civic-6",
                title: "Klima Radyatör Delinmesi",
                description: "Klima kondenserinin taş gelmesi sonucu kolayca delinmesi ve gaz kaçırması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "5.000 - 10.000 TL"
            ...
            {
                id: "civic-3",
                title: "Yakıt Pompası (Denso)",
                description: "Denso marka yakıt pompasının pervanesinin şişmesi ve aracın stop etmesi (Geri çağırma var).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Rastgele",
            ...
            {
                id: "civic-4",
                title: "CVT Bakımsızlık Sorunu",
                description: "Şanzıman yağı ve filtrelerin zamanında değişmemesi sonucu silkeleme ve kopma.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "40.000 km (Bakım)",
                repairCost: "Şanzıman Revizyonu"
            },
            {
                id: "civic-7",
                title: "LPG Subap Ayarı",
                description: "LPG'li araçlarda 40.000 km'de bir subap ayarı yapılmazsa tekleme ve çekiş düşüklüğü.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Her 40.000 km",
                repairCost: "2.000 - 4.000 TL"
            },
            {
                id: "civic-5",
                title: "Boya Vernik Atması",
                description: "Özellikle beyaz renkli araçlarda tavan ve kaputta vernik soyulması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "5+ Yıl",
                repairCost: "Boyama / Kaplama"
            }
        ],
        pros: [
            "LPG tam uyumu",
        ...
        buyingTips: [
            "C sütununu elinizle kontrol edin",
            "Direksiyon kutusundan ses geliyor mu?",
            "Yakıt pompası değişimi yapılmış mı?"
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "focus-3",
                title: "Triger Kayışı (Yağlı Kayış)",
                description: "Kayış yağ içinde çalışır. Orijinal olmayan yağ kullanımı kayışı eritip motoru kilitler (Çok Kritik).",
                category: "motor",
                riskLevel: "CRITICAL",
            ...
            {
                id: "focus-1",
                title: "Otomatik Şanzıman Vuruntusu",
            ...
            },
            {
                id: "focus-5",
                title: "EGR Valfi Tıkanıklığı",
                description: "Kurum birikmesi sonucu EGR valfinin tıkanması ve çekiş düşüklüğü.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "50.000+ km",
                repairCost: "5.000 - 10.000 TL"
            ...
            {
                id: "focus-6",
                title: "Silindir Kapak Contası",
                description: "Motor hararetine bağlı conta yanması ve suya yağ karışması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "25.000 - 40.000 TL"
            ...
            {
                id: "focus-2",
                title: "Akü Sensörü (BMS)",
                description: "Akü sensörü arızasıyla Start-Stop sisteminin devre dışı kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 - 4.000 TL"
        ...
        pros: [
            ...
            "Sessiz kabin",
            "LPG uyumu (Tam otomatik)"
        ],
        cons: [
            "Yakıt tüketimi yüksek (10L)",
            "Atmosferik motor performansı zayıf"
        ],
        buyingTips: [
            "Şanzıman geçişlerini kontrol edin (vuruntu var mı)"
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "troc-1",
                title: "Kangaroo Effect (Silkeleme)",
                description: "Soğuk motorda ilk kalkışta aracın ileri geri silkelemesi (1.5 TSI Evo kronik).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "0-30.000 km",
                repairCost: "Yazılım Güncelleme"
            },
            {
                id: "troc-3",
                title: "DSG Mekatronik Arızası",
                description: "Viteslerde kararsızlık, titreme veya 'Şanzıman Acil Mod' uyarısı.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "30.000 - 50.000 TL"
            ...
            {
                id: "troc-4",
                title: "Panoramik Cam Tavan Su Alma",
                description: "Tavan çerçevesinin çatlaması veya giderlerin tıkanması sonucu içeri su sızdırması.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "15.000 - 30.000 TL (Çerçeve Değişimi)"
            },
            {
                id: "troc-5",
                title: "Direksiyon Kolonu Sesi",
                description: "Dönüşlerde direksiyon altında gelen sürtünme/gıcırtı sesi (Airbag sargısı).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "5.000 - 10.000 TL"
            ...
            {
                id: "troc-2",
                title: "Start-Stop ve Elektronik Hatalar",
                description: "Start-stop devreye girmemesi veya hayalet ekranın donması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Akü"
            ...
            {
                id: "troc-6",
                title: "Kapı Trim Sesleri",
                description: "Sert plastik kapı döşemelerinden gelen tıkırtı sesleri.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Yalıtım"
        ...
        cons: [
            "Malzeme kalitesi (Polo ile aynı)",
            "Arka diz mesafesi"
        ],
        buyingTips: [
            "Kangaroo efektini test edin (Soğuk motor)"
        ]
    },
    {
        ...
        issues: [
            {
                ...
                description: "Ön amortisör kule bilyalarının ve takozlarının çabuk bozulması (Kronik Tıkırtı).",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "40.000+ km",
                repairCost: "4.000 - 8.000 TL"
            },
            {
                id: "fiorino-2",
                title: "Triger Zincir Sesi",
                description: "1.3 MultiJet motorlarda zincir uzaması sonucu şakırtı sesi (Koparsa motor dağılır).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "15.000 - 25.000 TL (Zincir Seti)"
            },
            {
                id: "fiorino-3",
                title: "EGR ve DPF Tıkanıklığı",
                description: "Sürekli şehir içi kullanımda kurum birikmesi ve çekiş düşüklüğü.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                id: "fiorino-4",
                title: "Turbo Islık Sesi",
                description: "Turbo milinde boşluk oluşması ve ötme yapması (Yağ yakmaya sebep olur).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "15.000 - 30.000 TL"
            },
            {
                id: "fiorino-5",
                title: "Enjektör Arızası",
                description: "Kötü yakıt kaynaklı enjektörlerin işemesi ve duman atma.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "10.000 - 20.000 TL"
            },
            {
                ...
                description: "Yağ soğutucunun çürümesi sonucu suya yağ karışması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "5.000 - 10.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "golf8-1",
                title: "Multimedya ve Ekran Kararması",
                description: "Ekranın tamamen siyah olması, donması veya sesin gelmemesi.",
                category: "elektronik",
                riskLevel: "HIGH",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / 5F Beyin Değişimi"
            },
            {
                id: "golf8-2",
                title: "SOS Acil Çağrı Hatası",
                description: "Gösterge panelinde sürekli 'SOS Hatası: Servise Gidin' uyarısı.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Anten Modülü"
            },
            {
                id: "golf8-3",
                title: "Asistan Sistemleri Devre Dışı",
                description: "Travel Assist ve Şerit Takip sensörlerinin hata vermesi (Direksiyon Değişimi Gerekebilir).",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "20.000+ km",
                repairCost: "20.000 - 40.000 TL"
            },
            {
                ...
                description: "Özellikle 1. ve 2. vites geçişlerinde metalik ses ve silkeleme.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "30.000 - 50.000 TL (Kavrama)"
            },
            {
                id: "golf8-5",
                title: "Anahtar Tanınamadı Hatası",
                description: "Anahtar araç içinde olsa bile aracın çalışmaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
        ...
        pros: [
            "Sürüş teknolojileri",
            "Sessizlik",
            "Yakıt tüketimi (Mild Hybrid)"
        ],
        cons: [
            "Karmaşık dokunmatik kontroller",
    ...
    },
    {
        ...
        issues: [
            {
                id: "polo-1",
                title: "DSG Mekatronik ve Kavrama",
                description: "Kuru kavrama şanzımanın ısınması, titremesi ve mekatronik kart arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "30.000 - 50.000 TL"
            },
            {
                ...
                description: "1.0 TSI motorlarda segman ve subap lastiği kaynaklı yağ tüketimi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
            ...
            },
            {
                ...
                description: "Mekanik el freni tabançasındaki düğmenin yerinden çıkması veya kırılması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "1.000 - 2.000 TL"
            },
            {
                ...
                description: "Viraj demir lastikleri ve burçlardan gelen gıcırtı sesleri.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "3.000 - 6.000 TL"
            ...
            {
                id: "polo-5",
                title: "Devirdaim Kaçağı",
                description: "Termostat ve devirdaim pompasından su sızdırması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "5.000 - 10.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "AdBlue sistem arızası ve 'Motoru Çalıştıramazsınız' uyarısı (Pompa/Enjektör).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "40.000+ km",
                repairCost: "20.000 - 40.000 TL"
            },
            {
                id: "caddy-2",
                title: "Arka Amortisör Sesi",
                description: "Süspansiyonun özellikle tümseklerde vuruntu yapması (Yazılımla düzelmez, parça değişimi).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Sıfırdan itibaren",
                repairCost: "Garanti / 5.000 - 10.000 TL"
            },
            {
                id: "caddy-3",
                title: "EGR ve DPF Tıkanıklığı",
                description: "Şehir içi kullanımda partikül filtresi ve EGR valfinin dolması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "Temizlik / İptal"
            },
            {
                id: "caddy-4",
                title: "SOS Acil Çağrı Hatası",
                description: "Tavan kontrol ünitesindeki arıza nedeniyle SOS uyarısı.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Değişim"
            ...
            {
                id: "caddy-5",
                title: "Enjektör Arızası (2.0 TDI)",
                description: "Yakıt kalitesine bağlı enjektör bozulması ve titreme.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 30.000 TL"
        ...
        cons: [
            "Yüksek fiyat",
            "Yılda bir muayene (Ticari)"
        ],
        buyingTips: [
            "AdBlue hatası var mı?",
            "Süspansiyon sesini dinleyin"
        ]
    },
    {
        ...
        issues: [
            {
                ...
                description: "Direksiyonun düz yolda takılı kalması ve 'dişli atlama' hissi (Kritik Güvenlik Sorunu).",
                category: "suspansiyon",
                riskLevel: "HIGH",
            ...
            },
            {
                id: "fe1-2",
                title: "Boya Kalitesi",
                description: "Özellikle kapı kolları, ayna ve tamponlarda boya atması/soyulması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "2-3 Yıl",
            ...
            {
                id: "fe1-4",
                title: "Klima Kompresör Keçesi",
                description: "Klima gaz kacağı ve soğutmama problemi.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "10.000 - 20.000 TL"
            ...
            {
                id: "fe1-5",
                title: "Gaz Kelebeği Donması",
                description: "Çok soğuk havalarda nemlenmeye bağlı gaz kelebeği takılması.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Kış Ayları",
                repairCost: "Temizlik"
        ...
        cons: [
            "Yalıtım (Hala sınıfının gerisinde)",
            "Yakıt tüketimi (Performanslı kullanımda 10L+)"
        ],
        buyingTips: [
            "Direksiyonu tam tur çevirip dinleyin",
            "Boya kalınlığına baktırın (İnce boya)"
        ]
    },
    {
        ...
        issues: [
            ...
            {
                id: "city-3",
                title: "Boya Kalitesi ve Soyulma",
                description: "Özellikle beyaz renklerde tavan ve kaputta boya atması.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "3-4 Yıl",
                repairCost: "Kozmetik Tamir"
            },
            {
                ...
                description: "Sıcak havalarda klimanın soğutma kapasitesinin yetersiz kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Çözümsüz"
            },
            {
                id: "city-2",
                title: "Multimedya Donması",
                description: "Ekranın yavaş çalışması ve geri görüş kamerasının geç gelmesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            },
            {
                ...
                description: "Hızlanmalarda gelen metalik kayış sesi (Lastik bant etkisi).",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
    ...
    },
    {
        ...
        issues: [
            {
                id: "crv-1",
                title: "Yapışkan Direksiyon",
                description: "Direksiyonun düz yolda takılı kalması ve 'dişli atlama' hissi (Kritik Güvenlik).",
                category: "suspansiyon",
                riskLevel: "HIGH",
                affectedKm: "10.000+ km",
            ...
            },
            {
                id: "crv-2",
                title: "12V Akü Bitmesi",
                description: "Hibrit aracın birkaç gün yatması sonucu 12V aküsünün boşalması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Kısa Mesafe / Yatma",
                repairCost: "Akü Takviyesi / Değişim"
            },
            {
                id: "crv-3",
            ...
            {
                id: "crv-4",
                title: "Benzin Karışması (Oil Dilution)",
                description: "Kışın kısa mesafe kullanımda yağa benzin karışması.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Kış Ayları",
                repairCost: "Sık Yağ Değişimi"
            ...
            {
                id: "crv-5",
                title: "Yüksek Yol Sesi",
                description: "Özellikle arka taraftan gelen lastik uğultusu.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "İzolasyon"
        ...
        pros: [
            "Devasa iç hacim",
            "Konfor",
            "i-MMD Hibrit sistemi (Sorunsuz)"
        ],
        cons: [
            "CVT şanzıman uğultusu",
            "Multimedya ekranı çok demode"
        ],
        buyingTips: [
    ...
    },
    {
        ...
        issues: [
            {
                id: "fiesta-1",
                title: "Triger Kayışı (Wet Belt) Parçalanması",
                description: "Yağ içinde çalışan triger kayışının zamanla parçalanarak yağ pompasını tıkaması ve motoru kitlemesi (Hayati Risk).",
                category: "motor",
                riskLevel: "CRITICAL",
                affectedKm: "40.000+ km / 5 Yıl",
                repairCost: "40.000 - 60.000 TL (Sandık Motor)"
            },
            {
                id: "fiesta-2",
                title: "Su Pompası ve Hararet",
            ...
            },
            {
                id: "fiesta-3",
                title: "Turbo Arızası",
                description: "Yağ basıncı düşüklüğü nedeniyle turbonun yağsız kalıp bozulması.",
                category: "motor",
                riskLevel: "HIGH",
            ...
            },
            {
                ...
                description: "Direkt enjeksiyon nedeniyle subaplarda kurum birikmesi ve tekleme.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "50.000+ km",
            ...
            },
            {
                ...
                description: "Yağ ve yakıt karışım bozuklukları nedeniyle katalizörün erken dolması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "10.000 - 20.000 TL"
    ...
    },
    {
        ...
        issues: [
            ...
            {
                id: "puma-2",
                title: "Su Kaçağı ve Hararet",
                description: "Silindir kapağı veya termostat gövdesinden su kaçağı (Conta yanmasına neden olabilir).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "50.000+ km",
                repairCost: "10.000 - 20.000 TL"
            },
            {
                ...
                description: "Bagaj altındaki plastik havuzun (MegaBox) tahliye tapasından su alması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Yağışlı Havalar",
                repairCost: "Yalıtım / Tapa Değişimi"
            },
            {
                id: "puma-4",
                title: "Çarpışma Önleme Asistanı Hatası",
                description: "Sensör arızası nedeniyle ön çarpışma asistanının devre dışı kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Sensör Temizliği"
            },
            {
                id: "puma-5",
                title: "Turbo Arızası",
                description: "Yağ basınç sorunları nedeniyle turbonun işlevini yitirmesi.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Kayışa Bağlı",
                repairCost: "20.000 - 30.000 TL"
            }
        ],
        pros: [
            "Bagaj çözümü (MegaBox)",
            "Tasarım",
            "Sürüş keyfi"
        ],
        cons: [
        ...
        issues: [
            {
                ...
                description: "Bazı üretimlerde 7mm zincir kullanılması sonucu zincir kopması ve motor hasarı (8mm ile değişim önerilir).",
                category: "motor",
                riskLevel: "CRITICAL",
            ...
            },
            {
                id: "kuga-3",
                title: "Turbo Arızası",
                description: "Turbo milinde boşluk ve ses yapması (Islık sesi).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 40.000 TL"
            ...
            {
                id: "kuga-4",
                title: "Vites Seçici (Rotary Gear)",
        ...
        issues: [
            {
                id: "c3-1",
                title: "Triger Kayışı",
                description: "Yağlı triger kayışının parçalanarak yağ pompasını tıkaması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
            ...
            },
            {
                id: "c3-2",
                title: "Yağ Eksiltme",
                description: "Motor yağ yakma sorunu.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "Motor Revizyonu"
    ...
    },
    {
        ...
        issues: [
            {
                id: "celysee-2",
                title: "Eksantrik Zinciri",
                description: "1.5 BlueHDi motorlarda zincir kopma riski (7mm zincir). Revizesiz ise motor yersiniz.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000 - 120.000 km",
                repairCost: "100.000+ TL"
            },
            {
                id: "celysee-1",
                title: "AdBlue",
                description: "AdBlue depo arızası (Kronik PSA sorunu).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "15.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "f10-1",
                title: "N20 Zincir Seti",
                description: "N20 motorlarda yağ pompası ve eksantrik zincirinin uzaması (Hayati Risk).",
                category: "motor",
                riskLevel: "HIGH",
            ...
            },
            {
                ...
                description: "Turbo wastegate veya selenoid valf arızası kaynaklı güç kısıtlaması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 30.000 TL"
            },
            {
                ...
                description: "İç kapı tutamaklarının yapış yapış olması ve erimesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "2.000 - 4.000 TL"
        ...
        cons: [
            "N20 zincir riski",
            "Yüksek bakım maliyeti",
            "Trim sesleri (Premium hissettirmiyor)"
        ],
        buyingTips: [
            "Zincir seti değişmiş mi? (Ses dinleyin)",
            "Yağ kaçağı kontrolü yapın",
            "İç trimleri kontrol edin"
        ]
    },
    {
        id: "bmw-f10-520d",
        ...
        issues: [
            {
                id: "f10d-1",
                title: "N47 Zincir Sesi",
                description: "Dizel motorlarda zincir şakırtısı ve kopma riski (2012 öncesi daha riskli).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "40.000 - 60.000 TL"
            },
            {
                id: "f10d-2",
                title: "EGR Soğutucu",
                description: "EGR soğutucusunun delinmesi ve su eksiltme.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
        ...
        cons: [
            "Zincir riski",
            "EGR yangın riski (Geri çağırma var)",
            "AdBlue sistemi"
        ],
        buyingTips: [
            "EGR değişimi yapıldı mı? (Yetkili servis kaydı)",
            "Zincir sesi var mı?"
        ]
    },
    {
        ...
        issues: [
            {
                id: "f30-1",
                title: "N20 Zincir Problemi",
                description: "Motor yağı basınç düşüklüğü uyarısı ve zincir sesi.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "30.000 - 50.000 TL"
            ...
            {
                id: "f30-2",
                title: "Su Genleşme Kabı",
                description: "Yedek su deposunun çatlaması ve su kaçağı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "3.000 - 6.000 TL"
        ...
        cons: [
            ...
            "Deri koltuk çatlaması"
        ],
        buyingTips: [
            "Zincir değişimi faturası isteyin",
            "Su kaçağı (terleme) var mı bakın"
        ]
    },
    {
        id: "bmw-g20-320i",
        ...
        issues: [
            ...
            },
            {
                ...
                description: "Direksiyondan gelen tıkırtı sesi (Garantiden değişim).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "30.000+ km",
                repairCost: "Garantiden/Revizyon"
            },
            {
                id: "g20-2",
        ...
        pros: [
            "Modern teknoloji",
            "B48 motor güvenilirliği (N20'ye göre çok iyi)",
            "Yalıtım"
        ],
        cons: [
            "Yüksek fiyat",
    ...
    },
    {
        ...
        issues: [
            {
                id: "w205-1",
                title: "NOx Sensörü",
                description: "Dizel ve benzinli motorlarda NOx sensörü arızası (Motor arıza lambası).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "15.000 - 25.000 TL"
        ...
        buyingTips: [
            "NOx sensörü değişmiş mi?",
            "Akustik cam opsiyonu var mı?"
        ]
    },
    {
        ...
        issues: [
            {
                id: "w212-1",
                title: "Eksantrik Dişlisi",
                description: "M271 motorlarda eksantrik dişlisi sıyırması (İlk çalıştırmada ses).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "30.000 - 50.000 TL"
            ...
            {
                id: "w212-2",
                title: "Arka Stop Lambaları",
                description: "LED stopların sönük yanması veya bozulması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "5.000 - 10.000 TL"
        ...
        buyingTips: [
            "İlk çalıştırmada zincir sesi var mı?",
    ...
    },
    {
        ...
        issues: [
            {
                id: "a4b8-1",
                title: "Yağ Yakma (TFSI)",
                description: "Benzinli motorlarda ciddi yağ tüketimi (Segman revizyonu gerekir).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "50.000 - 80.000 TL"
            ...
            {
                id: "a4b8-2",
                title: "Multitronic Beyin",
                description: "CVT şanzıman beyni arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "20.000 - 40.000 TL"
        ...
        cons: [
            "Yağ yakma sorunu (Benzinli)",
            "Multitronic şanzıman riski"
        ],
        buyingTips: [
            "Yağ tüketimi testi isteyin",
            "Dizel tercih edin (TDI daha sorunsuz)"
        ]
    },
    {
        ...
        issues: [
            {
                id: "a3-8v-1",
                title: "DSG Kavrama",
                description: "S-Tronic şanzımanda titreme ve kavrama bitmesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "20.000 - 30.000 TL"
            },
            {
                id: "a3-8v-2",
                title: "Termostat",
                description: "Su kaçağı yapan termostat ünitesi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "5.000 - 8.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "leon-1",
                title: "SOS Hatası",
                description: "Acil durum çağrı sistemi hatası (Yazılım).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            ...
            {
                id: "leon-2",
                title: "Golf 8 Sendromu",
                description: "Dokunmatik ekran ve yazılım bugları.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
        ...
        cons: [
            "Dokunmatik ergonomisi",
            "Yazılım sorunları"
        ],
        buyingTips: [
            "SOS hatası veriyor mı bakın"
        ]
    },
    {
        ...
        issues: [
            {
                id: "ibiza-1",
                title: "Klima Flap Sesi",
                description: "Klima yönlendirme motorlarından gelen ses.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 - 4.000 TL"
        ...
        pros: [
            "Sınıfının en sportifi",
            "Performanslı motor",
            "Genişlik"
        ],
        cons: [
            "Sert plastik",
            "Yalıtım (Polo'dan kötü)"
        ],
        buyingTips: [
            "DSG vites geçişlerini kontrol edin"
        ]
    ...
    },
    {
        ...
        issues: [
            {
                id: "omoda-1",
                title: "Yüksek Yakıt Tüketimi",
                description: "Şehir içi kullanımda 12-14 litreleri bulan yüksek yakıt tüketimi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Sürekli",
                repairCost: "LPG Uyumsuz"
            },
            {
                id: "omoda-2",
                title: "Multimedya Sorunları",
                description: "Kablosuz CarPlay kopmaları ve ekranın tamamen kararması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
            ...
            {
                id: "omoda-3",
                title: "ABS/ESP Sensör Arızası",
                description: "Fren sisteminde sensör arızası nedeniyle göstergede uyarı ışıklarının yanması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Sensör Değişimi"
            },
            {
                id: "omoda-4",
                title: "Boya Kalitesi",
                description: "Özellikle kaput ve tavanda taş izlerine bağlı boya atması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "PPF Kaplama Şart"
            },
            {
                id: "omoda-5",
                title: "Süspansiyon Sertliği",
                description: "Arka süspansiyonun sert olması ve tümseklerde vuruntu sesi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
        ...
        buyingTips: [
            "Yakıt tüketimini göze alarak alın"
        ]
    },
    {
        id: "tesla-model-y-lr",
    ...
    },
    {
        ...
        issues: [
            {
                id: "focus3-1",
                title: "Powershift KABUSU",
                description: "Şanzıman kartı ve kavraması kronik olarak bozulur. Bazen yolda bırakır.",
                category: "sanziman",
                riskLevel: "CRITICAL",
                affectedKm: "60.000+ km",
            ...
            },
            {
                id: "focus3-2",
                title: "Enjektör",
                description: "Dizel enjektör şakırtısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "150.000+ km",
        ...
        buyingTips: [
            "Powershift ise vites geçişlerine çok dikkat edin"
        ]
    },
    {
        id: "honda-civic-fb7",
        ...
        issues: [
            {
                id: "fb7-1",
                title: "Boya Kalitesi",
                description: "Çok ince ve çizilmeye müsait boya.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Sürekli",
                repairCost: "Kozmetik"
        ...
        buyingTips: [
            "LPG bakımını kontrol edin, şanzıman yağı değişmiş mi?"
        ]
    },
    {
        id: "vw-passat-b8-tdi",
        ...
        issues: [
            {
                id: "b8-1",
                title: "DSG Mekatronik",
                description: "DSG şanzıman mekatronik arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                id: "b8-2",
                title: "Volan",
                description: "Çift kütleli volan sesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "150.000+ km",
                repairCost: "15.000 TL"
        ...
        cons: [
            "DSG masraf riski",
            "Yüksek ikinci el fiyatı"
        ],
        buyingTips: [
            "DSG kavraması ve volan sesi kontrol edilmeli"
        ]
    },
    {
        id: "porsche-macan",
        ...
        issues: [
            {
                ...
                description: "Transfer kutusu (arazi şanzımanı) arızası ve titreme.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "100.000+ TL"
        ...
        buyingTips: [
            "Transfer kutusu değişmiş mi? Titreme var mı?"
        ]
    },
    {
        ...
        issues: [
            {
                id: "ateca-1",
                title: "Kangaroo Effect (Silkeleme)",
                description: "Motor soğukken ilk kalkışta ve düşük devirde silkeleme yapması.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Soğuk Havalar",
                repairCost: "Yazılım Güncelleme"
            ...
            {
                id: "ateca-2",
                title: "DSG Kararsızlığı",
                description: "Düşük hızlarda vites geçişlerinde sarsıntı ve kararsızlık.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Şehir İçi",
                repairCost: "Yazılım"
            },
            {
                ...
                description: "Devirdaim pompasından su kaçırması (1.5 TSI kronik).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "Değişim"
            },
            {
                id: "ateca-4",
                title: "Multimedya Donması",
                description: "Ekranın kilitlenmesi veya siyah ekran vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            },
            {
                ...
                description: "Elektrikli bagajın açılmaması veya yarım kalması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "Amortisör Değişimi"
            }
        ],
        pros: [
            "Geniş iç hacim",
    ...
    },
    {
        ...
        issues: [
            {
                id: "leon-1",
                title: "Multimedya Hataları",
                description: "Ekranın donması, kararması veya sistemin kendi kendine yeniden başlaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
            ...
            },
            {
                id: "leon-2",
                title: "SOS Acil Çağrı Hatası",
                description: "Tavandaki SOS modülünün arızalanması ve sürekli uyarı vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Modül Değişimi"
            ...
            {
                id: "leon-3",
                title: "Mild Hybrid Silkeleme",
                description: "Yavaşlarken veya rejenerasyon sırasında oluşan belirgin sarsıntı (Kangalama).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
            },
            {
                ...
                description: "48V sistemine rağmen 12V akünün çabuk bitmesi veya elektronik arızalara yol açması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Akü Değişimi"
            },
            {
                ...
                description: "Bagaj kapağındaki led barın (infinite light) kendiliğinden çatlaması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "Stop Değişimi"
            }
        ],
        pros: [
            "Keskin tasarım",
        ...
        cons: [
            ...
            "Malzeme kalitesi (alt kısımlar)"
        ],
        buyingTips: [
            "Ekranın dokunmatiğini test edin"
        ]
    },
    {
        ...
        issues: [
            {
                id: "ibiza-1",
                title: "DSG Mekatronik Arızası",
                description: "Vites geçişlerinde sarsıntı, tıkırtı sesi veya vitese geçmeme.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "60.000 - 120.000 km",
                repairCost: "40.000 - 60.000 TL"
            ...
            {
                id: "ibiza-2",
                title: "Turbo Wastegate (EPC)",
                description: "Wastegate çubuğunun takılması sonucu EPC ışığı ve güç kaybı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "40.000+ km",
            ...
            },
            {
                id: "ibiza-3",
                title: "Multimedya Donması",
                description: "Ekranın tepki vermemesi veya kendi kendine kapanması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            },
            {
                id: "ibiza-4",
                title: "Su Pompası Kaçağı",
                description: "Termostat gövdesi ile entegre su pompasından sızıntı (Hararet riski).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "Değişim"
            },
            {
                id: "ibiza-5",
                title: "Ön Takım Sesleri",
                description: "Z rotlar ve burçlardan gelen tıkırtı sesleri.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Bozuk Yollar",
                repairCost: "Parça Değişimi"
            }
        ],
        pros: [
            "Genç tasarım",
        ...
        issues: [
            {
                id: "arona-1",
                title: "Start-Stop Arızası",
                description: "Sistemin devreye girmemesi ve akü zayıflığı uyarısı.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Akü Değişimi"
            },
            {
                id: "arona-2",
                title: "Tavan Boyası Atması",
                description: "Çift renkli modellerde tavan boyasının vernik atması veya soyulması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "Boyama / Kaplama"
            ...
            },
            {
                id: "arona-4",
                title: "Rüzgar Sesi",
                description: "A sütunu ve aynalardan gelen rüzgar sesi (İzolasyon zayıflığı).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "110+ km/s",
                repairCost: "Fitil İyileştirmesi"
            },
            {
                id: "arona-5",
                title: "Multimedya Donması",
        ...
        issues: [
            {
                id: "superb-2",
                title: "Krom Çıta",
                description: "Cam çıtalarının oksitlenmesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kozmetik",
                repairCost: "2.000 TL"
            },
            {
                id: "superb-1",
                title: "AdBlue",
                description: "AdBlue enjektör tıkanması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "50.000+ km",
                repairCost: "5.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "c5a-1",
                title: "AdBlue Tankı",
                description: "AdBlue tankı deformasyonu ve pompa arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "20.000 TL"
            },
            {
                ...
                description: "Hayalet ekranın gidip gelmesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
        ...
        pros: [
            "Süspansiyon konforu",
            "Arka 3 bağımsız koltuk",
            "Genişlik"
        ],
        cons: [
            "Virajda yatma",
            "Multimedya yavaşlığı"
        ],
        buyingTips: [
            "AdBlue tankı değişmiş mi sorun"
        ]
    },
    {
        id: "citroen-c4-new",
        ...
        issues: [
            {
                id: "c4-1",
                title: "Tablet Tutucu",
                description: "Yolcu tarafı tablet tutucunun kırılması.",
                category: "govde",
                riskLevel: "LOW",
    ...
    },
    {
        ...
        issues: [
            ...
            },
            {
                id: "a180-2",
                title: "Süspansiyon Sertliği",
                description: "AMG Line paketinde aşırı sert sürüş hissi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
        ...
        buyingTips: [
            "AMG Line ise sürüşü test edin",
            "MBUX güncel mi bakın"
        ]
    },
    {
        id: "mercedes-cla-200",
        ...
        issues: [
            {
                ...
                description: "LED şeritlerde renk kayması veya yanmama.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
            ...
            },
            {
                id: "cla-1",
                title: "DCT Titremesi",
                description: "Düşük hızlarda kavrama titremesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "30.000+ km",
                repairCost: "20.000 - 35.000 TL"
        ...
        buyingTips: [
            "Yokuş kalkışında titreme var mı?"
        ]
    },
    {
        id: "mercedes-gla-200",
        ...
        issues: [
            {
                ...
                description: "Nadir durumlarda subap/kapak sorunları (M282 motor).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "Motor Revizyonu"
            },
            {
                ...
                description: "Kamera kapağının açılmaması veya siyah ekran.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Mekanizma Değişimi"
            },
            {
                id: "gla-3",
                title: "Termostat",
                description: "Elektronik termostat arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "8.000+ TL"
        ...
        issues: [
            {
                id: "x1-1",
                title: "Zincir Gergi",
                description: "B38 motorlarda zincir gergi sesi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
            ...
            },
            {
                id: "x1-2",
                title: "Yağ Kaçağı",
                description: "Vanos biriminden yağ sızıntısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "8.000 - 15.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "a3-8y-1",
                title: "Dokunmatik Klima",
                description: "Dokunmatik klima kontrollerinin geç tepki vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Çözümsüz (Tasarım)"
            },
            {
                id: "a3-8y-2",
                title: "DSG Titreme",
                description: "Kuru kavrama DSG titremesi (DQ200).",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "50.000+ km",
        ...
        issues: [
            {
                ...
                description: "Panoramik tavanın açılırken takılması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
    ...
    },
    {
        ...
        issues: [
            {
                id: "compass-2",
                title: "Elektrik Sorunları",
                description: "Çeşitli sensör ve elektrik arızaları.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "5.000 - 15.000 TL"
            },
            {
                id: "compass-1",
                title: "DCT Şanzıman",
                description: "DDCT kararsızlık ve titreme.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "40.000+ km",
                repairCost: "30.000 - 50.000 TL"
        ...
        buyingTips: [
            "DDCT şanzımanı mutlaka test edin",
            "Arıza geçmişini sorun"
        ]
    },
    {
        ...
        issues: [
            {
                id: "renegade-1",
                title: "Zincir Sesi",
                description: "1.3 T4 motorlarda zincir sesi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "renegade-2",
                title: "İnfotainment",
                description: "Uconnect sisteminin donması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "3.000 - 8.000 TL"
        ...
        pros: [
            "Şirin tasarım",
            "Arazi yeteneği",
            "Fiat altyapısı (Ucuz parça)"
        ],
        cons: [
            "Güvenilirlik soru işareti",
    ...
    },
    {
        ...
        issues: [
            {
                id: "vitara-1",
                title: "Multimedya",
                description: "Eski model multimedyanın yavaş çalışması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Aftermarket değişim"
            }
        ],
        pros: [
            "Japon güvenilirliği",
        ...
        cons: [
            "Eski tasarım multimedya",
            "Yalıtım orta"
        ],
        buyingTips: [
            "AllGrip 4x4 tercih edin"
        ]
    },
    {
        ...
        issues: [
            {
                id: "formentor-2",
                title: "Trim Sesleri",
                description: "Konsol ve kapı trimlerinden gelen sesler.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Bozuk yolda",
                repairCost: "2.000 - 5.000 TL"
            },
            {
                id: "formentor-1",
                title: "Kangaroo Effect",
                description: "1.5 TSI DSG düşük hızlarda silkeleme.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "0-30.000 km",
                repairCost: "3.000 - 8.000 TL (Yazılım)"
            }
        ],
        pros: [
            "Etkileyici tasarım",
        ...
        issues: [
            {
                id: "born-1",
                title: "12V Akü",
                description: "12V aküsünün beklenenden erken bitmesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "20.000+ km",
                repairCost: "5.000 - 10.000 TL"
        ...
        issues: [
            {
                id: "ds7-1",
                title: "Triger Kayışı",
                description: "PureTech wet belt sorunu (PSA kronik).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "50.000+ km",
                repairCost: "30.000 - 50.000 TL"
            },
            {
                id: "ds7-2",
                title: "EAT8 Sarsıntı",
                description: "Düşük hızlarda hafif sarsıntı.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yazılım"
    ...
    },
    {
        ...
        issues: [
            {
                id: "superb-1",
                title: "DSG Mekatronik",
                description: "DSG DQ200 kuru kavrama titreme ve mekatronik arızası.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "18.000 - 38.000 TL"
            },
            {
                id: "superb-2",
                title: "Su Pompası",
                description: "TSI motorlarda su pompası sızıntısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "8.000 - 15.000 TL"
        ...
        pros: [
            "D segment en büyük iç hacim",
            "VW kalitesi Skoda fiyatına",
            "Pratik/konforlu"
        ],
        cons: [
            "DSG DQ200 riski",
            "Yüksek tüketim (Şehir içi)"
        ],
        buyingTips: [
            "DSG geçişlerini test edin",
            "Su pompası değişmiş mi bakın"
        ]
    },
    {
        ...
        issues: [
            {
                id: "octavia-1",
                title: "Kangaroo Effect",
                description: "1.5 TSI e-Tec soğuk motorla silkeleme.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "0-30.000 km",
                repairCost: "3.000 - 8.000 TL (Yazılım)"
            },
            {
                id: "octavia-2",
                title: "Infotainment",
                description: "Multimedya sistemi donmaları.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 - 5.000 TL"
        ...
        pros: [
            "Segment en geniş iç hacim",
            "Ekonomik mild hibrit",
            "VW MQB Evo"
        ],
        cons: [
            "Yazılım sorunları",
        ...
        issues: [
            {
                id: "kamiq-1",
                title: "Multimedya Donması",
                description: "Bolero/Amundsen ekran donması ve siyah ekran sorunu.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Güncelleme"
            ...
            {
                id: "kamiq-2",
                title: "Kapı Fitilleri (Rüzgar Sesi)",
                description: "Yüksek hızda kapı fitillerinin rüzgar sesi yapması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "110+ km/s",
                repairCost: "Fitil İyileştirmesi"
            ...
            {
                id: "kamiq-3",
                title: "Front Assist Hatası",
                description: "Ön bölge asistanının gereksiz fren yapması veya devre dışı kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Kalibrasyon"
            ...
            },
            {
                id: "kamiq-5",
                title: "SOS Acil Çağrı Hatası",
                description: "SOS modülünün arızalanması ve sürekli uyarı vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Modül Değişimi"
    ...
    },
    {
        ...
        issues: [
            {
                id: "scala-1",
                title: "Multimedya Donması",
                description: "Bolero/Amundsen ekran donması ve yeniden başlama sorunları.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Güncelleme"
            },
            {
                id: "scala-2",
                title: "Klima Arızası",
                description: "Klima sensör ve ve kompresör arızaları nedeniyle soğutmama.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "40.000+ km",
                repairCost: "Sensör / Kompresör"
            },
            {
                id: "scala-3",
                title: "Fren Disklerinde Erken Aşınma",
                description: "Ön fren disklerinin beklenenden erken aşınması ve ses yapması.",
                category: "fren",
                riskLevel: "LOW",
                affectedKm: "30.000 km",
                repairCost: "Disk/Balata Değişimi"
            },
            {
                id: "scala-4",
                title: "Kapı Fitilleri (Rüzgar Sesi)",
                description: "Kapı fitillerinin zayıflığı veya yerinden çıkması nedeniyle rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "110+ km/s",
                repairCost: "Fitil İyileştirmesi"
            },
            {
                id: "scala-5",
                title: "Triger Zinciri Sesi",
                description: "1.0 TSI motorlarda zincir gergi sesi (Bakım önemli).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "Zincir Değişimi"
            }
        ],
        pros: [
            "Büyük bagaj (467L)",
        ...
        buyingTips: [
            "Motor çalışırken zincir sesi var mı dinleyin"
        ]
    },
    {
        ...
        issues: [
            {
                id: "f30-1",
                title: "Zincir Sesi ve Kırılması",
                description: "N20 motorlarda zincir paletlerinin kırılması ve motor hasarı riski (2015 öncesi kritik).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "40.000 - 70.000 TL"
            },
            {
                id: "f30-2",
                title: "Su Kaçağı ve Hararet",
                description: "Genleşme kabı çatlaması, termostat ve elektrikli devirdaim pompası arızaları.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 30.000 TL"
            },
            {
                id: "f30-3",
                title: "Yağ Kaçakları",
                description: "Külbütör kapağı ve yağ kütüğü contalarından yağ sızdırması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "10.000 - 20.000 TL"
            ...
            {
                id: "f30-4",
                title: "Yapışan Kapı Kolları",
                description: "Kapı içi tutamakların zamanla erimesi ve ele yapışması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "2.000 - 5.000 TL"
            },
            {
                ...
                description: "Turbo hortumları veya bobin arızası nedeniyle güç kısıtlaması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "5.000 - 15.000 TL"
        ...
        buyingTips: [
            "Zincir sesini mutlaka dinleyin",
            "Motor altında yağ izi var mı bakın"
        ]
    },
    {
        ...
        issues: [
            {
                id: "f10-1",
                title: "Zincir Sesi ve Kırılması",
                description: "N20 motorlarda zincir paletlerinin kırılması (2015 öncesi kritik).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "40.000 - 70.000 TL"
            ...
            {
                id: "f10-2",
                title: "Su Alma Problemi",
                description: "Kapı yalıtımları (bakalit) ve sunroof gideri tıkanması sonucu içeri su alma.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Zamanla",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                id: "f10-3",
                title: "Yağ Kaçakları",
                description: "Külbütör kapağı ve yağ kütüğü contalarından sızdırma.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "10.000 - 20.000 TL"
            ...
            {
                id: "f10-4",
                title: "Tuş ve Kapı Kolu Erimesi",
                description: "Klima tuşları ve kapı tutamaklarının soyulması/erimesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "2.000 - 5.000 TL"
            },
            {
                ...
                description: "Turbo wastegate valfi arızası ve güç kaybı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 30.000 TL"
        ...
        buyingTips: [
            "Hava süspansiyonlu değilse tercih edin",
            "N20 zincir kontrolü şart"
        ]
    },
    {
        ...
        issues: [
            {
                id: "f10d-1",
                title: "Zincir Sesi ve Kopması (N47)",
                description: "N47 motorlarda (2010-2014) zincir kopması ve motor hasarı riski (Kritik).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "40.000 - 70.000 TL"
            },
            {
                ...
                description: "EGR soğutucusundaki kaçak nedeniyle yangın riski (Geri çağırma kontrol edilmeli).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Her an",
            ...
            },
            {
                id: "f10d-3",
                title: "Su Alma Problemi",
                description: "Kapı yalıtımları ve bagaj havalandırma kapağından su alma.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Zamanla",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                id: "f10d-4",
                title: "Krank Kasnağı",
                description: "Krank kasnağındaki kauçuğun kopması ve ses yapması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "150.000+ km",
                repairCost: "8.000 - 15.000 TL"
        ...
        buyingTips: [
            "Dizel tercih edin (N47 daha sağlam)"
        ]
    },
    {
        ...
        issues: [
            {
                id: "superb16-1",
                title: "DSG Mekatronik ve Kavrama",
                description: "DQ200 kuru kavrama şanzımanda titreme, mekatronik kart arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "30.000 - 50.000 TL"
            },
            {
                id: "superb16-2",
                title: "EGR ve DPF Tıkanıklığı",
                description: "Şehir içi kullanımda EGR valfi ve DPF'nin erken dolması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Şehir İçi",
                repairCost: "10.000 - 20.000 TL"
            },
            {
                ...
                description: "Elektronik devirdaim pompasının sıkışması ve hararet riski.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "8.000 - 15.000 TL"
            },
            {
                ...
                description: "AdBlue enjektörü veya pompa arızası (Kristalleşme).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                ...
                description: "Tümsek geçişlerinde arkadan gelen lokurtu sesi (Burçlar).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "3.000 - 6.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "golf7-1",
                title: "DSG Mekatronik",
                description: "Vites geçişlerinde kararsızlık ve titreme. Basınç tüpü değişimi gerekebilir.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 45.000 TL"
            ...
            {
                id: "golf7-3",
                title: "Multimedya Dokunmatik",
                description: "Ekranın bazı bölgelerinde dokunmatik hassasiyeti kaybı.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "3.000 - 8.000 TL"
            },
            {
                id: "golf7-2",
                title: "Devirdaim Pompası",
                description: "Su kaçağı ve soğutma sıvısı eksiltme.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "90.000+ km",
                repairCost: "5.000 - 10.000 TL"
        ...
        buyingTips: [
            "DSG kavramasının durumunu ekspertizde kontrol ettirin."
        ]
    },
    {
        ...
        issues: [
            {
                id: "focus35-1",
                title: "Powershift Kavrama ve Beyin",
                description: "Dizel modellerde ıslak kavrama olsa da düşük hızlarda silkeleme ve beyin (TCM) arızası yapabilir.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "30.000 - 50.000 TL"
            },
            {
                id: "focus35-2",
                title: "Direksiyon Kutusu Sesi",
                description: "Bozuk yollarda direksiyon kutusundan gelen tıkırtı sesi ve boşluk.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
            ...
            {
                id: "focus35-3",
                title: "Su Horton Kaçağı",
                description: "Motor soğutma hortumlarında çatlama sonucu su eksiltme ve hararet riski.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Zamanla",
                repairCost: "5.000 - 10.000 TL"
            ...
            {
                id: "focus35-4",
                title: "Motor Takozu (Kulak)",
                description: "Özellikle sağ üst kulaktaki yıpranma sonucu içeriye aşırı vibrasyon verme.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "120.000+ km",
                repairCost: "4.000 - 8.000 TL"
            ...
            {
                id: "focus35-5",
                title: "Enjektör Geri Dönüş",
                description: "Dizel enjektör diplerinde terleme veya pulların aşınması sonucu koku.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "150.000+ km",
        ...
        cons: [
            "Arka diz mesafesi dar",
            "Bagaj hacmi rakiplerinden az"
        ],
        buyingTips: [
            "Otomatik şanzımanın vites geçişlerini yokuşta deneyin."
        ]
    },
    {
        id: "opel-astra-k-14t",
        ...
        issues: [
            {
                id: "leon3-1",
                title: "Trim Sesleri",
                description: "Kapı içlerinden ve sunroof'tan gelen tıkırtılar.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "30.000+ km",
                repairCost: "1.000 - 3.000 TL"
            },
            {
                id: "leon3-2",
                title: "Su Devirdaim",
                description: "Termostat veya devirdaim kaynaklı su eksiltme.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "4.000 - 9.000 TL"
            },
            {
                id: "leon3-3",
                title: "DSG Kavrama",
                description: "Titreme ve vuruntu.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "70.000+ km",
                repairCost: "25.000 - 40.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "clio4-1",
                title: "Rüzgar Sesi",
                description: "90 km/s üzeri hızlarda ayna diplerinden rüzgar sesi alır.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Çözümsüz/Fitil"
            },
            {
                id: "clio4-2",
                title: "EDC Beyni",
                description: "Vites kutusu beyni nadiren arıza yapabilir.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "150.000+ km",
                repairCost: "15.000 - 25.000 TL"
        ...
        cons: [
            "Plastik kalitesi",
            "Arka camlar manuel (baz donanım)",
            "Rüzgar sesi"
        ],
        buyingTips: [
            "Triger setinin 80.000 km veya 4 yılda bir değiştiğinden emin olun."
        ]
    },
    {
        id: "hyundai-i20-mpi",
    ...
    },
    {
        ...
        issues: [
            {
                id: "jazz-1",
                title: "CVT Titreme",
                description: "Şanzıman yağı zamanında değişmezse kalkışta titreme.",
                category: "sanziman",
                riskLevel: "LOW",
        ...
        buyingTips: [
            "CVT şanzıman yağının değişim periyodunu (40.000 km) kontrol edin."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "c3-2",
                title: "Yağ Eksiltme",
                description: "1.2 motorlarda belirli serilerde yağ yakma.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "Motor Revizyonu"
            },
            {
                id: "c3-1",
                title: "Amortisör Sesi",
                description: "Ön amortisörlerden gelen lokurtu.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "3.000 - 6.000 TL"
        ...
        cons: [
            "Viraj performansı (Yatıyor)",
            "Multimedya yavaş"
        ],
        buyingTips: [
            "Airbump'ların durumuna ve kapı altlarında hasar olup olmadığına bakın."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Kapıların kilitlenmemesi veya açılmaması.",
                category: "elektronik",
                riskLevel: "LOW",
            ...
            },
            {
                id: "polo-1",
                title: "EGR Tıkanıklığı",
                description: "Dizel motorlarda EGR valfi arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "70.000+ km",
                repairCost: "5.000 - 10.000 TL"
        ...
        buyingTips: [
            "Enjektör sesini dinleyin, 1.4 TDI motorlar biraz sesli çalışır ama vuruntu olmamalı."
        ]
    },
    {
        id: "skoda-octavia-a7",
        ...
        issues: [
            {
                id: "octavia-1",
                title: "Su Pompası",
                description: "Devirdaim su kaçağı (Kronik VW grubu).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "90.000+ km",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                id: "octavia-2",
                title: "DSG Mekatronik",
                description: "Şanzıman kartı arızası.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "25.000 - 45.000 TL"
        ...
        pros: [
            "Devasa bagaj (Liftback)",
            "Geniş arka diz mesafesi",
            "Fiyat/Performans"
        ],
        cons: [
            "Rüzgar sesi (Ayna)",
            "Süspansiyon sesli çalışıyor"
        ],
        buyingTips: [
            "Aile için en mantıklı sedan. Bagaj havuzunu kontrol edin."
        ]
    },
    {
        id: "honda-city-new",
        ...
        issues: [
            {
                id: "city-new-2",
                title: "CVT Kararsızlığı",
                description: "Düşük hızlarda şanzımanın kararsız kalması (Lastik bant etkisi).",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
            },
            {
                id: "city-new-1",
                title: "Yalıtım",
                description: "Yol ve rüzgar sesi yalıtımının zayıf olması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Sürekli",
                repairCost: "Kozmetik"
            },
            {
                id: "city-new-3",
                title: "Yakıt Pompası",
                description: "1.0 Turbo modellerde yakıt pompası arızası.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "40.000+ km",
                repairCost: "10.000 TL"
        ...
        cons: [
            ...
            "Frenler (Kampana arka)"
        ],
        buyingTips: [
            "Yalıtım eksikliğini bilerek alın, şehir içi için mükemmeldir."
        ]
    },
    {
        id: "fiat-linea-mjet",
        ...
        issues: [
            {
                id: "linea-1",
                title: "Zincir Sesi",
                description: "Triger zincirinin uzaması ve ses yapması (Koparsa motor biter).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "10.000 - 20.000 TL"
            },
            {
                id: "linea-2",
                title: "Amortisör Takozu",
                description: "Direksiyonu çevirirken gelen gıcırtı.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "50.000+ km",
                repairCost: "2.000 - 4.000 TL"
        ...
        buyingTips: [
            "Taksi çıkması olup olmadığını TRAMER ve KM kayıtlarından çok iyi araştırın."
        ]
    },
    {
        ...
        issues: [
            {
                id: "3008-1",
                title: "AdBlue Kristalleşme",
                description: "AdBlue deposunun tıkanması ve komple değişim gerektirmesi.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 40.000 TL"
            },
            {
                id: "3008-2",
                title: "Kaput Dalgalanması",
                description: "Yüksek hızda kaputun titremesi (Aerodinamik hata).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "120+ km/s",
                repairCost: "Çözümsüz/Ayar"
            }
        ],
        pros: [
            "i-Cockpit",
        ...
        cons: [
            "AdBlue sorunu",
            "Arka süspansiyon sert (Torsiyon)"
        ],
        buyingTips: [
            "AdBlue iptali yapılıp yapılmadığını veya deponun değişip değişmediğini sorun."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "duster-1",
                title: "Direksiyon Kutusu",
                description: "Direksiyondan gelen sesler ve boşluk.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "10.000 - 15.000 TL"
            ...
            {
                id: "duster-2",
                title: "Yakıt Şamandırası",
                description: "Göstergenin yanlış göstermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "2.000 - 4.000 TL"
        ...
        buyingTips: [
            "1.3 TCe motorun performansı şaşırtıcıdır, test edin."
        ]
    },
    {
        id: "vw-tiguan-tsi",
        ...
        issues: [
            {
                id: "tiguan-1",
                title: "DSG Titreme",
                description: "Kalkışlarda titreme (Kavrama aşınması).",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "70.000+ km",
                repairCost: "25.000 - 40.000 TL"
        ...
        buyingTips: [
            "Highline/Elegance donanım cam tavansız alınmaz (Piyasa kuralı)."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "2008-1",
                title: "Triger Kayışı",
                description: "Yağ içinde çalışan kayışın deformasyonu (Kontrol şart).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "50.000+ km",
                repairCost: "20.000 TL"
            ...
            {
                id: "2008-2",
                title: "Multimedya Donma",
                description: "Ekranın siyah olması veya donması.",
                category: "elektronik",
                riskLevel: "LOW",
        ...
        buyingTips: [
            "GT donanımda gelen 3D kokpit çok etkileyicidir, giriş paketi sönük kalır."
        ]
    },
    {
        id: "opel-mokka-b",
        ...
        issues: [
            {
                id: "mokka-1",
                title: "Start Stop",
                description: "Devreye girmeme sorunu (Akü kaynaklı).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "2-3 Yıl",
                repairCost: "Akşam Değişimi"
            }
        ],
        pros: [
            "Vizör tasarım",
        ...
        cons: [
            "İç mekan çok dar",
            "Arka camlar küçük (klostrofobik)",
            "Bagaj küçük"
        ],
        buyingTips: [
            "Arka koltuk diz mesafesini mutlaka deneyin, aileye uygun olmayabilir."
        ]
    },
    {
        id: "citroen-c5-aircross",
        ...
        issues: [
            {
                id: "c5a-2",
                title: "Bagaj Kapağı",
                description: "Elektrikli bagajın açılmaması veya yarıda kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "5.000 TL"
            },
            {
                id: "c5a-1",
                title: "AdBlue Pompası",
                description: "AdBlue sistemi arızası (Grup geneli sorun).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "70.000+ km",
        ...
        pros: [
            "Uçan halı süspansiyon",
            "Bağımsız 3 arka koltuk",
            "Sessizlik"
        ],
        cons: [
            "Virajda yatma",
            "Multimedya tuşları dokunmatik (kullanışsız)"
        ],
        buyingTips: [
    ...
    },
    {
        ...
        issues: [
            {
                id: "kuga-1",
                title: "12V Akü",
                description: "Aracın çalışmamasına neden olan akü bitirme sorunu.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Akü Değişimi"
        ...
        pros: [
            "Sürüş dinamiği",
            "Kaydırılabilir arka koltuk",
            "Sessiz dizel"
        ],
        cons: [
            "Döner vites seçici alışkanlık ister",
            "Bagaj normal"
        ],
        buyingTips: [
            "ST-Line süspansiyonu biraz serttir, konfor için Titanium bakın."
        ]
    },
    {
        id: "renault-captur-2",
        ...
        issues: [
            {
                id: "captur-1",
                title: "Start Stop",
                description: "Devreye girmeme.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Aküye bağlı",
                repairCost: "Akü"
            }
        ],
        pros: [
            "Kaliteli iç mekan (Eskiye göre)",
            "Mercedes motoru",
            "Bagaj"
        ],
        cons: [
            "Multimedya bazen yavaş",
            "EDC kararsızlığı"
        ],
        buyingTips: [
            "Çift renk tavanlı modeller ikinci elde daha hızlı satılır."
        ]
    },
    {
        ...
        issues: [
            {
                id: "chery-1",
                title: "Yüksek Yakıt Tüketimi",
                description: "Şehir içi 11-13 litre arası yakıt tüketimi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Sürekli",
            ...
            {
                id: "chery-2",
                title: "Multimedya ve Kamera Arızaları",
                description: "Ekran donması ve 360 derece kamera sisteminin hata vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            },
            {
                ...
                description: "Düşük hızlarda ve dur-kalk trafikte şanzıman kararsızlığı/silkelemesi.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Şehir İçi",
                repairCost: "Yazılım"
            ...
            {
                id: "chery-4",
                title: "Klima Paneli Çatlaması",
                description: "Dokunmatik klima panelinin kendiliğinden çatlaması veya vernik atması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "Panel Değişimi"
            },
            {
                id: "chery-5",
                title: "Rüzgar Sesi",
                description: "Yüksek hızlarda (110 km/s+) içeriye belirgin rüzgar sesi alması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Yüksek Hız",
                repairCost: "Fitil İyileştirmesi"
        ...
        cons: [
            "Çok yakıyor",
            "Servis ağı yeni",
            "Süspansiyon yumuşak (Salınım)"
        ],
        buyingTips: [
            "Yakıtı dert etmiyorsanız bu fiyata alabileceğiniz en lüks gemidir. PPF kaplatın."
        ]
    },
    {
        ...
        issues: [
            {
                id: "renegade-1",
                title: "Turbo Valfi",
                description: "Turbo basınç valfi (N75) arızası ve güç kaybı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "3.000 - 5.000 TL"
            },
            {
                id: "renegade-2",
                title: "Start-Stop",
                description: "Sistemin çalışmaması (Fiat grubu kroniği).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Sensör"
        ...
        buyingTips: [
            "Arazide kullanılmış mı diye altına baktırın, şehir cipi olsa da zorlayanlar var."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "f30-1",
                title: "Su Eksiltme",
                description: "Genleşme tankı veya hortumlardan soğutma sıvısı kaçırma.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "5.000 - 15.000 TL"
            },
            {
                id: "f30-2",
                title: "Tahrik Uyarısı",
                description: "Bobin/Buji veya Turbo valfi kaynaklı güç kısıtlama.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "10.000 - 30.000 TL"
            ...
            {
                id: "f30-3",
                title: "Kapı Kolu Erimi",
                description: "İç kapı kollarının yapış yapış olması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "2.000 TL"
        ...
        pros: [
            "Arkadan itiş (Drift)",
            "ZF Şanzıman",
            "Performans (Yazılıma açık)"
        ],
        cons: [
            "Çok yakıyor (10L+)",
            "Hor kullanılmış araç çok"
        ],
        buyingTips: [
            "Harman Kardon ve NBT ekran olup olmadığına bakın, bunlar aracın değerini çok etkiler."
        ]
    },
    {
        id: "audi-a3-8v-sedan",
        ...
        issues: [
            {
                id: "a3-1",
                title: "DSG Mekatronik",
                description: "S-Tronic şanzıman beyni arızası.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "90.000+ km",
                repairCost: "30.000 TL"
        ...
        cons: [
            "Donanım fakiri (Bazı paketler)",
            "Arkası dar"
        ],
        buyingTips: [
            "Matrix LED farlı modelleri tercih edin, gece sürüşü muazzamdır."
        ]
    },
    {
        id: "volvo-xc40-t3",
        ...
        issues: [
            {
                ...
                description: "Hey Mercedes sisteminin gereksiz devreye girmesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "-",
                repairCost: "-"
    ...
    },
    {
        ...
        issues: [
            {
                id: "g30-1",
                title: "Klima Ekranı",
                description: "Klima panelinde çatlama (Kronik).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "15.000 TL"
        ...
        buyingTips: [
            "Vakum kapı ve hayalet ekran opsiyonlarını arayın."
        ]
    },
    {
        id: "audi-a4-b9",
        ...
        issues: [
            {
                id: "a4-1",
                title: "AdBlue",
                description: "AdBlue sistem hatası (TDI motorlarda).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "20.000 TL"
        ...
        buyingTips: [
            "Quattro olmayan önden çekişli modeller daha ekonomiktir ama Quattro keyfi başkadır."
        ]
    },
    {
        id: "volvo-s60-new",
        ...
        issues: [
            {
                id: "cla-1",
                title: "Trim Sesleri",
                description: "Sert süspansiyon nedeniyle iç mekandan gelen sesler.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "-"
    ...
    },
    {
        ...
        issues: [
            ...
            },
            {
                id: "doblo-2",
                title: "Amortisör Takozu",
                description: "Ön takımdan gelen sesler.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "2.000 - 4.000 TL"
        ...
        cons: [
            "Yalıtım",
            "Performans (1.3 motor yüklüyken)"
        ],
        buyingTips: [
    ...
    },
    {
        ...
        issues: [
            {
                id: "caddy-1",
                title: "Enjektör",
                description: "Kötü yakıta bağlı enjektör arızası.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "30.000 - 50.000 TL"
        ...
        cons: [
            "Arka makas sistemi (Zıplatma)",
            "Fiyat"
        ],
        buyingTips: [
            "DSG şanzımanlı alıyorsanız kavrama testini mutlaka yapın."
        ]
    },
    {
        ...
        issues: [
            {
                id: "fiorino-1",
                title: "Amortisör Kulesi",
                description: "Ön süspansiyon takozlarından ses gelmesi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "30.000+ km",
                repairCost: "2.000 TL"
        ...
        buyingTips: [
            "LPG'li 1.4 versiyonu çok yakar, 1.3 Dizel tercih edin."
        ]
    },
    {
        ...
        issues: [
            {
                id: "rifter-1",
                title: "AdBlue",
                description: "Grup geneli AdBlue depo sorunu.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "30.000 TL"
        ...
        buyingTips: [
            "Cam tavanlı GT paket bir SUV kadar konforludur."
        ]
    },
    {
        ...
        pros: [
            "Modutop tavan (Saklama alanı)",
            "Konfor",
            "Genişlik"
        ],
        cons: [
            "Elektronik el freni bazen takılı kalabilir",
            "AdBlue"
        ],
        buyingTips: [
            "Modutop tavanlı versiyonları çocuklu aileler için birebirdir."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "ranger-1",
                title: "Şanzıman (10 İleri)",
                description: "Vites geçişlerinde vuruntu (Yazılım ile düzelir).",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
        ...
        buyingTips: [
            "Off-road donanımı sonradan takılan araçların şasi kontrollerini iyi yapın."
        ]
    },
    {
        id: "renault-kangoo-3",
        ...
        cons: [
            "Fiyat (Rakiplerinden pahalı)",
            "Kapı direği yok (Güvenlik?)"
        ],
        buyingTips: [
            "Opsiyonel B sütunu olmayan model çok havalıdır ama kaza güvenliği sorgulanmalıdır."
        ]
    },
    {
        id: "tofas-sahin-ie",
        ...
        issues: [
            {
                id: "sahin-3",
                title: "Çürük",
                description: "Alt taban ve çamurluk ağızlarında çürüme.",
                category: "govde",
                riskLevel: "HIGH",
                affectedKm: "Yaşa bağlı",
                repairCost: "15.000 - 30.000 TL"
            },
            {
                id: "sahin-1",
                title: "Hararet",
                description: "Conta yakma (Efsane kronik).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Her an",
                repairCost: "5.000 TL"
            },
            {
                id: "sahin-2",
                title: "Diferansiyel",
                description: "Diferansiyel ötmesi.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "3.000 TL"
        ...
        buyingTips: [
            "Çürük çarık olmayan, şasisi düzgün bir tane bulmak imkansıza yakındır."
        ]
    },
    {
        id: "togg-t10x-v2",
    ...
    },
    {
        ...
        issues: [
            {
                id: "punto-1",
                title: "City Modu",
                description: "Direksiyon sertleşmesi ve city motoru arızası (Kronik).",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "8.000 - 15.000 TL"
            },
            {
                id: "punto-2",
                title: "Torpido Çatlaması",
                description: "Yolcu hava yastığı kısmından torpidonun çatlaması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Güneş etkisi",
                repairCost: "Kozmetik"
            }
        ],
        pros: [
        ...
        cons: [
            "Yalıtım",
            "Performans (75hp versiyon)",
            "City modu riski"
        ],
        buyingTips: [
            "Torpido çatlağına dikkat edin, tamiri zordur. City modunu açıp kapatarak direksiyonu test edin."
        ]
    },
    {
        ...
        issues: [
            {
                id: "fluence-1",
                title: "EDC Beyni",
                description: "Otomatik viteslerde şanzıman beyni arızası.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "20.000 - 35.000 TL"
        ...
        cons: [
            "İmaj (Şirket/Kiralama)",
            "Yol tutuş (Yumuşak)",
            "Direksiyon hissiz"
        ],
        buyingTips: [
            "Makam perdesi olan Touch Plus veya Icon paketleri tercih edin. Şirket çıkması olmayan temizini bulmak zordur."
        ]
    },
    {
        ...
        issues: [
            {
                id: "talisman-1",
                title: "4Control Sistemi",
                description: "Arka tekerlek yönlendirme sisteminde ses ve boşluk.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "30.000 TL"
            },
            {
                id: "talisman-2",
                title: "R-Link Ekran",
                description: "Ekranın kararması veya dokunmatik kaybı.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "10.000 TL"
        ...
        cons: [
            "İkinci eli yavaş",
            "Parçası pahalı (Kaporta)",
            "Rüzgar sesi"
        ],
        buyingTips: [
            "4Control sistemi olanları alırken mutlaka yetkili serviste ekspertiz yaptırın."
        ]
    },
    {
        ...
        issues: [
            {
                id: "jetta-1",
                title: "DSG Kavrama",
                description: "Titreme ve vuruntu (Klasik DSG sorunu).",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "70.000+ km",
            ...
            },
            {
                id: "jetta-2",
                title: "Kapı Döşemesi",
                description: "Kumaş döşemelerin sarkması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Yaşa bağlı",
                repairCost: "2.000 TL"
        ...
        cons: [
            "Meksika üretimi (Malzeme kalitesi Golf'ten düşük)",
            "Yalıtım"
        ],
        buyingTips: [
            "Meksika üretimi olduğu için Golf kalitesi beklemeyin ama bagajı için alınır."
        ]
    },
    {
        ...
        issues: [
            {
                id: "arteon-1",
                title: "Sunroof Çıtırdaması",
                description: "Kasa esnemesi kaynaklı tavan sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Bakım"
    ...
    },
    {
        ...
        issues: [
            {
                id: "mondeo-1",
                title: "Şanzıman Vuruntusu",
                description: "6F35 şanzımanın 2-3 geçişlerinde sarsıntı.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "Elektrovalf/Yağ"
            },
            {
                id: "mondeo-2",
                title: "Direksiyon Kutusu",
                description: "Elektrikli direksiyon arızası (Nadir).",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "150.000+ km",
                repairCost: "25.000 TL"
        ...
        pros: [
            "Aston Martin ön panjur",
            "Sessizlik (Sınıf lideri)",
            "Yol tutuş"
        ],
        cons: [
            "Yakıt tüketimi (11-12LT)",
            "Ağır kasa"
        ],
        buyingTips: [
            "Yakıtı dert etmiyorsanız Passat'tan daha konforlu ve sessiz bir araçtır."
        ]
    },
    {
        id: "honda-civic-fb7",
        ...
        issues: [
            {
                id: "fb7-1",
                title: "Boya Kalitesi",
                description: "Vernik atması ve ince boya.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "Kozmetik"
        ...
        pros: [
            ...
            "LPG ile bedava geziyor",
            "İkinci el peynir ekmek"
        ],
        cons: [
            "Yalıtım sıfır",
            "Performans düşük"
        ...
        buyingTips: [
            "LPG dolum ağzı benzin kapağında olan (Fabrikasyon) modelleri tercih edin."
        ]
    },
    {
        ...
        issues: [
            {
                id: "auris-1",
                title: "Yağ Yakma",
                description: "Bazı 1.33 motorlarda yağ eksiltme (1.6 sorunsuz).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "150.000+ km",
                repairCost: "Revizyon"
        ...
        cons: [
            "Multimedya saati 80'lerden kalma",
            "CVT motor bağırır"
        ],
        buyingTips: [
            "Cam tavanlı (Skypack) olmayanları ikinci elde zor satılır."
        ]
    },
    {
        ...
        issues: [
            {
                id: "accent-2",
                title: "Amortisör",
                description: "Arka tarafın sekmesi (Yol tutuş zayıf).",
                category: "suspansiyon",
                riskLevel: "HIGH",
                affectedKm: "Yapısal",
                repairCost: "Çözümsüz"
        ...
        pros: [
            "Roket gibi motor (136hp dizel)",
            "Sorunsuz otomatik",
            "Parça ucuz"
        ],
        cons: [
            "Yol tutuş çok kötü (Arka savurur)",
            "Frenler zayıf"
        ],
        buyingTips: [
            "Hız yapmayı seviyorsanız uzak durun, arka tarafı çok oynar. Şehir içi ve performans için harikadır."
        ]
    },
    {
        id: "ford-ranger-wildtrak",
        ...
        issues: [
            {
                id: "ranger-1",
                title: "Şanzıman (10 İleri)",
                description: "Vites geçişlerinde kararsızlık ve ısınma.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "Ağır kullanım",
                repairCost: "40.000 TL"
            },
            {
                id: "ranger-2",
                title: "AdBlue Enjektörü",
                description: "Tıkanma.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "50.000+ km",
        ...
        buyingTips: [
            "Sürgü kapaklı bagaj ve dodik setli olanlar daha değerlidir."
        ]
    },
    {
        ...
        issues: [
            {
                id: "transporter-1",
                title: "EGR Valfi",
                description: "Tıkanma ve güç kaybı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 TL"
        ...
        buyingTips: [
            "VIP yapılı araç alıyorsanız ruhsata işli olup olmadığına (9+1) mutlaka bakın."
        ]
    },
    {
        ...
        issues: [
            {
                ...
                description: "Ağır arazide pompanın ses yapması.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 TL"
            },
            {
                id: "amarok-2",
                title: "DPF Tıkanıklığı",
                description: "Şehir içi kullanımda DPF uyarısı.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Şehir içi",
        ...
        pros: [
            "V6 motor gücü",
            "Konfor (Kamyonet değil SUV gibi)",
            "Prestij"
        ],
        cons: [
            "Yakıt tüketimi (12-13L)",
            "Park sorunu (Genişlik)"
        ],
        buyingTips: [
            "2.0 TDI dört silindirli yerine mutlaka V6 TDI alın, yakıtı aynı performansı çok farklıdır."
        ]
    },
    {
        id: "bmw-x5-xdrive30d",
        ...
        issues: [
            {
                id: "x5-1",
                title: "Hava Süspansiyonu",
                description: "Körüklerin zamanla inmesi.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "120.000+ km",
                repairCost: "40.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Eksik soğutma sıvısı uyarısı (Hortum kaçağı).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 TL"
        ...
        cons: [
            "Benzinli motor çok yakar (11L)",
            "Rüzgar sesi"
        ],
        buyingTips: [
            "M Sport süspansiyon serttir, konfor için xLine tercih edilebilir."
        ]
    },
    {
        id: "bmw-g30-520i",
        ...
        buyingTips: [
            "Borusan çıkışlı ve \"Special Edition\" (Vakum/Hayalet/Harman) olmasına dikkat edin."
        ]
    },
    {
        id: "audi-q5-40-tdi",
        ...
        issues: [
            {
                id: "q5-1",
                title: "AdBlue",
                description: "AdBlue dozajlama hatası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "15.000 TL"
        ...
        issues: [
            {
                id: "a6-1",
                title: "MMI Ekranlar",
                description: "Alt dokunmatik ekranın tepki vermemesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
    ...
    },
    {
        ...
        issues: [
            {
                id: "arona-1",
                title: "Kapı Sesi",
                description: "Kapı fitillerinden gelen rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Fitil Ayarı"
        ...
        buyingTips: [
            "Çift renk tavanlı modelleri tercih edin, karakter katıyor."
        ]
    },
    {
        id: "seat-leon-1-5-tsi",
        ...
        issues: [
            {
                id: "leon-1",
                title: "Multimedya",
                description: "Ekranın geç açılması veya donması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılımsal",
                repairCost: "Güncelleme"
            },
            {
                id: "leon-2",
                title: "SOS Hatası",
                description: "Acil durum çağrı sistemi hatası.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılımsal",
                repairCost: "Servis"
        ...
        cons: [
            ...
            "Malzeme kalitesi (Golf altı)"
        ],
        buyingTips: [
            "FR paket kırmızı renk Leon'un olmazsa olmazıdır."
        ]
    },
    {
        ...
        issues: [
            {
                ...
                description: "MIB3 sisteminin kilitlenmesi ve yeniden başlaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Güncelleme"
            ...
            {
                id: "cupra-vz-2",
                title: "Sunroof Kumandası",
                description: "Dokunmatik tavan kumandasının hassasiyet sorunu.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Modül değişimi"
            },
            {
                id: "cupra-vz-3",
                title: "DSG Gecikmesi",
                description: "Kalkışlarda gaz pedalına geç tepki verme.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Pedal Box / Yazılım"
            }
        ],
        pros: [
            "Saf performans (300hp)",
            "Ses",
            "Sürüş zevki"
        ],
        cons: [
    ...
    },
    {
        ...
        issues: [
            {
                id: "ds4-3",
                title: "Süspansiyon",
                description: "Düşük hızlarda süspansiyonun sert hissedilmesi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
            },
            {
                id: "ds4-1",
                title: "Yazılım Hataları",
                description: "Gösterge paneli ve ekranın kararması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Güncelleme"
            },
            {
                id: "ds4-2",
                title: "Krom Detaylar",
                description: "Dış krom parçaların erken matlaşması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Dış etken",
                repairCost: "Kozmetik"
            }
        ],
        pros: [
        ...
        buyingTips: [
            "Sıradan olsun istemiyorsanız, yoldaki en şık araç budur."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                id: "polo-tdi-1",
                title: "EGR",
                description: "EGR valfi tıkanıklığı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "10.000 TL"
        ...
        cons: [
            "Motor sesi (3 silindir)",
            "Arka diz mesafesi"
        ],
        buyingTips: [
            "Dizel Polo her zaman \"çeyrek altın\"dır, satarken hiç üzmez."
        ]
    },
    {
        ...
        issues: [
            {
                id: "a3-tdi-2",
                title: "MMI Ekran ",
                description: "Ekran mekanizmasının bozulması (Çıkıp girmemesi).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "5.000 TL"
        ...
        cons: [
            "Donanım (Boş paket çok)",
            "Bakım"
        ],
        buyingTips: [
            "Sunroof olmayan A3'ler çok zor satılır, mutlaka cam tavanlı bakın."
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Tüm kontrollerin ekranda olması ve bozulması.",
                category: "elektronik",
                riskLevel: "HIGH",
                affectedKm: "Rastgele",
                repairCost: "10.000 - 20.000 TL"
            ...
            {
                id: "cactus-1",
                title: "Katalizör Hatası",
                description: "P0420 katalitik konvertör arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "15.000 TL"
        ...
        cons: [
            "Devir saati yok",
            "Arka camlar açılmıyor"
        ],
        buyingTips: [
            "Otomatik şanzıman sarsıntılı olabilir (ETG). EAT6 tercih edin."
        ]
    },
    {
        id: "vw-tcross",
        ...
        issues: [
            {
                id: "tcross-1",
                title: "Devirdaim",
                description: "Su pompası arızası ve su kaçağı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "5.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "taigo-1",
                title: "DSG Kararsızlık",
                description: "Düşük hızda vites geçişlerinde kararsızlık.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yazılım"
        ...
        buyingTips: [
            "Coupe SUV sevenler için iyi alternatif."
        ]
    },
    {
        id: "skoda-karoq",
        ...
        issues: [
            {
                id: "karoq-1",
                title: "Kangaroo Effect",
                description: "1.5 TSI motor soğukken silkeleme.",
                category: "motor",
                riskLevel: "LOW",
            ...
            {
                id: "karoq-2",
                title: "Kapı Fitil Sesi",
                description: "Rüzgar sesi alma.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "İzolasyon"
    ...
    },
    {
        ...
        issues: [
            {
                id: "kodiaq-2",
                title: "Su Pompası",
                description: "Elektronik devirdaim arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "90.000+ km",
                repairCost: "8.000 TL"
        ...
        buyingTips: [
            "4x4 sistemini (Haldex) kontrol ettirin."
        ]
    },
    {
        id: "renault-koleos",
        ...
        issues: [
            ...
            },
            {
                id: "koleos-1",
                title: "CVT Şanzıman",
                description: "X-Tronic şanzıman uğultusu ve ısınma.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "40.000+ TL"
        ...
        buyingTips: [
            "Şanzıman yağını kontrol ettirin."
        ]
    },
    {
        id: "nissan-xtrail",
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Direksiyon ve vites topuzu soyulması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Kaplama"
            ...
            {
                id: "ix35-1",
                title: "Diferansiyel Sesi",
                description: "Diferansiyel ve şanzıman bilya sesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "10.000+ TL"
        ...
        buyingTips: [
            "LPG varsa sübap kontrolü yaptırın."
        ]
    },
    {
        id: "kia-niro",
    ...
    },
    {
        ...
        issues: [
            {
                id: "hrv-1",
                title: "CVT Sesi",
                description: "Şanzımandan gelen uğultu.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yağ Değişimi"
        ...
        buyingTips: [
            "CVT şanzıman yağının düzenli değiştiğinden emin olun."
        ]
    },
    {
        id: "suzuki-jimny",
    ...
    },
    {
        ...
        issues: [
            {
                id: "ecosport-1",
                title: "Yağ Pompası",
                description: "Triger kayışı parçacıklarının yağ pompasını tıkaması (Wet Belt).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                id: "ecosport-2",
                title: "Bagaj Kapağı",
                description: "Yana açılan kapak amortisörü sorunu.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 TL"
        ...
        buyingTips: [
            "Triger kayışını mutlaka sorun (Wet Belt riski)."
        ]
    },
    {
        id: "fiat-500x",
        ...
        issues: [
            {
                id: "500x-2",
                title: "Start-Stop",
                description: "Sistemin devreye girmemesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Akü Kaynaklı",
                repairCost: "Akü"
            },
            {
                id: "500x-1",
                title: "Turbo Hortumu",
                description: "Turbo hortumu çatlaması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "4.000 TL"
        ...
        pros: [
            "Tasarım",
            "Kalite (Jeep Renegade altyapısı)",
            "Yol tutuş"
        ],
        cons: [
            "Arka alan",
        ...
        buyingTips: [
            "Cross Plus donanım tercih edin."
        ]
    },
    {
        id: "mazda-cx3",
        ...
        issues: [
            {
                ...
                description: "Yarı otomatik robot arızası.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "15.000 - 25.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                id: "lat-2",
                title: "Soyulma",
                description: "Tuş takımlarının soyulması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
        ...
        buyingTips: [
            "Mutlaka 1.5 dCi alın, 2.0 dizel çok yakar."
        ]
    },
    {
        id: "renault-megane-3",
    ...
    },
    {
        ...
        issues: [
            {
                id: "focus3-1",
                title: "Direksiyon Kutusu",
                description: "Direksiyonda boşluk ve ses.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "10.000 TL"
            },
            {
                id: "focus3-2",
                title: "Baskı Balata",
                description: "Erken biten debriyaj seti.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "8.000 TL"
        ...
        buyingTips: [
            "Otomatik park asistanı olanları tercih edin."
        ]
    },
    {
        id: "opel-insignia-a",
        ...
        issues: [
            {
                id: "ins-a-3",
                title: "Subap Erimesi",
                description: "LPG uyumsuzluğu nedeniyle subap erimesi (Çelik subap şart).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "LPG ile 50.000 km",
                repairCost: "20.000 TL"
            },
            {
                id: "ins-a-1",
                title: "Turbo Valfi",
                description: "Turbo basınç valfi (Selenoid) arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "3.000 TL"
            },
            {
                id: "ins-a-2",
                title: "Su Eksiltme",
                description: "Genleşme kabı ve hortumlardan kaçak.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik",
                repairCost: "2.000 TL"
        ...
        buyingTips: [
            "2.0 CDTI dizel motor daha sorunsuzdur."
        ]
    },
    {
        id: "skoda-superb-2",
        ...
        issues: [
            {
                id: "sup2-2",
                title: "Klima Yönlendirme",
                description: "Klima klapelerinin takılması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "5.000 TL"
            },
            {
                id: "sup2-1",
                title: "DSG Mekatronik",
                description: "Şanzıman beyni arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "30.000 TL"
        ...
        pros: [
            "Makam aracı genişliği",
            "Twindoor bagaj",
            "Konfor"
        ],
        cons: [
            "Uzun şasi park sorunu",
            "Hantal (1.6 TDI)"
        ],
        buyingTips: [
            "Twindoor (çift açılır bagaj) mekanizmasını kontrol edin."
        ]
    },
    {
        id: "vw-scirocco",
        ...
        issues: [
            {
                id: "scirocco-1",
                title: "Piston Kırma",
                description: "160hp CAV motorlarda piston segman kanalı kırılması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "Rastgele",
                repairCost: "Motor Sandık: 100.000+ TL"
            },
            {
                id: "scirocco-2",
                title: "Zincir Sesi",
                description: "İlk çalıştırmada zincir sesi (Uzama).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "15.000 TL"
        ...
        buyingTips: [
            "Kesinlikle kompresyon testi yaptırın. 122hp (CAX) motor daha sağlamdır."
        ]
    },
    {
        id: "vw-beetle",
        ...
        buyingTips: [
            "Fender ses sistemi olanları tercih edin."
        ]
    },
    {
        ...
        issues: [
            {
                id: "picasso-1",
                title: "MCP Şanzıman",
                description: "Robotize şanzımanın sarsıntılı çalışması ve baskı balata bitirmesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "70.000+ km",
                repairCost: "15.000 TL"
            },
            {
                id: "picasso-2",
                title: "Ekran Arızası",
                description: "Hayalet ekranın kararması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "15.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Amortisörlerin ses yapması (Vuruntu).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Değişim"
            ...
            {
                id: "301-2",
                title: "Ampul Patlatma",
                description: "Sık sık far ampulü patlatması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Sürekli",
                repairCost: "Ampul"
        ...
        buyingTips: [
            "Taksi çıkması olup olmadığına dikkat edin."
        ]
    },
    {
        id: "honda-accord-2",
        ...
        issues: [
            {
                id: "accord-1",
                title: "Direksiyon Pompası",
                description: "Pompa sesi ve yağ kaçağı.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "150.000+ km",
                repairCost: "10.000 TL"
        ...
        cons: [
            "Yakıt tüketimi",
            "Yıllık vergi (2.0 motor)"
        ],
        buyingTips: [
            "LPG uyumu tamdır ama sübap ayarı ister."
        ]
    },
    {
        id: "toyota-camry",
        ...
        buyingTips: [
            "Makam aracı olarak kullanılmış olabilir."
        ]
    },
    {
        id: "hyundai-i20-troy",
    ...
    },
    {
        ...
        issues: [
            {
                id: "linea-1",
                title: "Zincir Sesi",
                description: "Triger zinciri sesi (Değişim gerektirir).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "8.000 TL"
        ...
        buyingTips: [
            "Taksi çıkması olmamasına dikkat edin (Kilometre düşürülmüş olabilir)."
        ]
    },
    {
        id: "vw-amarok-2-0",
        ...
        issues: [
            {
                id: "amarok-1",
                title: "Turbo Arızası",
                description: "Çift turbo (BiTDI) arızası ve yağ yakma.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "40.000 - 60.000 TL"
            ...
            {
                id: "amarok-2",
                title: "Şanzıman Isınma",
                description: "Ağır arazide otomatik şanzıman uyarısı.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "Zorlamada",
                repairCost: "Soğutma"
            }
        ],
        pros: [
        ...
        buyingTips: [
            "V6 motorlu olanlar çok daha sağlamdır, imkan varsa V6 alın."
        ]
    },
    {
        ...
        issues: [
            {
                id: "116i-1",
                title: "Su Eksiltme",
                description: "O-ring ve plastik parçalardan su kaçağı (N13 Motor).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "5.000 TL"
            },
            {
                id: "116i-2",
                title: "Tahrik Hatası",
                description: "Turbo, bobin veya sensör kaynaklı güç kısıtlaması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Değişken"
    ...
    },
    {
        ...
        issues: [
            {
                id: "caddy-1",
                title: "Enjektör",
                description: "Enjektör şakırtısı ve arızası (Cay motor).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "20.000 TL"
            },
            {
                id: "caddy-2",
                title: "EGR Valfi",
                description: "EGR tıkanması ve çekiş düşüklüğü.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "5.000 TL"
        ...
        pros: [
            "Konfor (Makaslı olmasına rağmen)",
            "Kalite",
            "İkinci el"
        ],
        cons: [
    ...
    },
    {
        ...
        issues: [
            {
                id: "kangoo-1",
                title: "Aks Körüğü",
                description: "Aks körüğü yırtılması.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "1.000 TL"
        ...
        buyingTips: [
            "Aile için Multix versiyonu alın."
        ]
    },
    {
        id: "audi-q2",
    ...
    },
    {
        ...
        issues: [
            ...
            },
            {
                id: "a1-2",
                title: "Zincir Sesi",
                description: "İlk çalıştırmada ses.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "10.000 TL"
    ...
    },
    {
        ...
        issues: [
            ...
            },
            {
                id: "218i-2",
                title: "Tahrik Uyarısı",
                description: "Yazılımsal hatalar.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Sık sık temizlik yapması.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Sürekli",
                repairCost: "Sabır"
        ...
        buyingTips: [
            "Şehirde kullanacaksanız park sorununu düşünün."
        ]
    },
    {
        id: "porsche-macan",
    ...
    },
    {
        ...
        issues: [
            {
                id: "fpace-1",
                title: "Zincir",
                description: "Ingenium motor zincir sorunu.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "150.000+ TL"
            },
            {
                id: "fpace-2",
                title: "Elektronik",
                description: "Ekran ve sensör hataları.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Değişken"
        ...
        buyingTips: [
            "Güzel ama riskli. Motor sesini iyi dinleyin."
        ]
    },
    {
        id: "chery-omoda-5",
        ...
        issues: [
            {
                ...
                description: "Beklenenden yüksek yakıt (10-12LT).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Sürekli",
                repairCost: "Yakıt"
        ...
        issues: [
            {
                id: "kadjar-1",
                title: "EDC Şanzıman",
                description: "Kavrama titremesi ve vites geçiş hatası.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 40.000 TL"
            },
            {
                id: "kadjar-2",
                title: "Rüzgar Sesi",
                description: "Ayna ve kapı fitillerinden ses alma.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "100+ km/h",
                repairCost: "1.500 TL"
        ...
        issues: [
            {
                id: "avensis-2",
                title: "DPF Tıkanıklığı",
                description: "Şehir içi kullanımda partikül filtresi uyarısı.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Sürekli Şehir İçi",
                repairCost: "3.000 TL (Temizlik)"
            },
            {
                id: "avensis-1",
                title: "Enjektör Sesi",
                description: "Soğuk motorda enjektör şakırtısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "12.000 - 20.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "2013 öncesi modellerde triger zinciri kopma riski.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "40.000 - 70.000 TL"
            },
            {
                id: "f30-d-2",
                title: "Turbo Arızası",
                description: "Yüksek km'de turbo ıslık sesi ve yağ kaçağı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "180.000+ km",
                repairCost: "20.000 TL"
            }
        ],
        pros: [
        ...
        buyingTips: [
            "Zincir değişmiş mi mutlaka sorun"
        ]
    },
    {
        id: "audi-a6-c7-tdi",
        ...
        issues: [
            {
                id: "a6-1",
                title: "Multitronic Beyni",
                description: "Şanzıman kartı arızası ve vites geçiş sorunu.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                id: "a6-2",
                title: "Su Kaçağı",
                description: "EGR soğutucusundan su eksiltme.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "120.000+ km",
                repairCost: "15.000 TL"
    ...
    },
    {
        ...
        issues: [
            {
                ...
                description: "Kırmızı akü uyarısı ve çalışmama sorunu.",
                category: "elektronik",
                riskLevel: "HIGH",
                affectedKm: "0-30.000 km",
            ...
            },
            {
                id: "w206-2",
                title: "Ekran Kararması",
                description: "MBUX ekranının kapanıp açılması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılımsal",
                repairCost: "Yazılım"
        ...
        buyingTips: [
            "Akü güncellemesi yapıldı mı sorun"
        ]
    },
    {
        ...
        issues: [
            {
                id: "glc-1",
                title: "Aks Titremesi",
                description: "Tam tur dönüşlerde önden gelen titreme (Crabbing).",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kış ayları",
            ...
            },
            {
                id: "glc-2",
                title: "Rüzgar Sesi",
                description: "Akustik cam yoksa 120+ km/h rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "120+ km/h",
                repairCost: "Normal"
    ...
    },
    {
        ...
        issues: [
            {
                id: "courier-1",
                title: "AdBlue",
                description: "Euro 6 motorlarda AdBlue ısıtıcı arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "15.000 TL"
        ...
        buyingTips: [
            "Titanium Plus paketini al, boş paket \"şirket çıkması\" olabilir."
        ]
    },
    {
        ...
        years: "2011-2018",
        generation: "Mk6",
        expertNote: "Meksika üretimi olduğu için Golf kadar kaliteli değildir ama bagajı yayladır. DSG mekatronik ve volan sesi fix menüdür, alırken kulağını iyi aç.",
        price: 950000,
        reliabilityScore: 76,
        totalIssues: 4,
        searchCount: 22000,
        issues: [
            {
                id: "jetta-1",
                title: "DSG Mekatronik",
                description: "Vites geçişlerinde kararsızlık, titreme ve \"Vites kutusu hatası\".",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                ...
                description: "Sıcağa maruz kalınca tavan kumaşının kendini salması (Kronik).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "7-8 Yıl",
                repairCost: "3.000 - 5.000 TL"
            },
            {
                id: "jetta-2",
                title: "Enjektör Şakırtısı",
                description: "1.6 TDI motorlarda soğukken gelen metalik vuruntu sesi.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "120.000+ km",
                repairCost: "20.000 - 35.000 TL"
            },
            {
                id: "jetta-4",
                title: "Devirdaim Kaçağı",
                description: "Triger setinin olduğu yerden antifriz sızdırması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "90.000+ km",
                repairCost: "8.000 - 15.000 TL"
        ...
        pros: [
            "Geniş bagaj (510 LT)",
            "Piyasa değeri (Altın gibi)",
            "Yakıt ekonomisi"
        ],
        cons: [
            "Meksika üretimi malzeme kalitesi",
            "DSG korkusu",
            "Yalıtım (Golf'ten kötü)"
        ],
        buyingTips: [
    ...
    },
    {
        ...
        years: "2009-2017",
        generation: "Mk3",
        expertNote: "CAV motor kodlu 160'lık ise piston kırma riski vardır, CTH kodlu (2013 sonrası) makbuldür. Apaçi elinde patlamışsa uzak dur.",
        price: 850000,
        reliabilityScore: 65,
        totalIssues: 3,
        searchCount: 18000,
        issues: [
            {
                id: "scirocco-2",
                title: "Zincir Sesi",
                description: "İlk çalıştırmada 2-3 saniye süren zincir şakırtısı (Gergi arızası).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "scirocco-1",
                title: "Piston Kırma",
                description: "160hp CAV motorlarda segman kanalı kırılması ve motorun bitmesi.",
                category: "motor",
                riskLevel: "CRITICAL",
            ...
            },
            {
                id: "scirocco-3",
                title: "DSG Kavrama",
                description: "Kuru kavrama 7 ileri DSG'nin 2. viteste titremesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "20.000 - 35.000 TL"
    ...
    },
    {
        ...
        years: "2012-2017",
        generation: "Mk1 Facelift",
        expertNote: "Passat'ın yakışıklı kardeşi. Çerçevesiz camlar havalıdır ama fitil eskirse rüzgar sesi baş ağrıtır. Elektroniği Passat'tan biraz daha hassastır.",
        price: 1100000,
        reliabilityScore: 78,
        totalIssues: 4,
        searchCount: 14000,
        issues: [
            {
                id: "cc-1",
                title: "Cam Fitil Sesi",
                description: "Çerçevesiz camların fitillerinin sertleşmesi sonucu rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Fitil Değişimi"
            },
            {
                ...
                description: "El freni motorunun bozulması ve tekerin kilitli kalması.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                id: "cc-2",
                title: "DSG Mekatronik",
                description: "Mekatronik kart ısınması ve vites karışıklığı.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                id: "cc-4",
                title: "Devirdaim",
                description: "TSI motorun klasik su kaçırma sorunu.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "8.000 - 15.000 TL"
        ...
        cons: [
            "Arka baş mesafesi",
            "Şehir içi sert süspansiyon",
            "Rüzgar sesi"
        ],
        buyingTips: [
            "Camları açıp kapatırken mekanizmayı dinleyin",
            "Arka lastiklerde aşınma dengesizliği var mı? (Camber)"
        ]
    },
    {
        id: "renault-fluence-1-5-dci",
    ...
    },
    {
        ...
        years: "2014-2022",
        generation: "Mk5",
        expertNote: "Amerikan konforu arayanlara birebir. Yalnız 1.5 motor bu kasayı taşırken içer, şehir içi 11-12 litreyi gözden çıkar. Şanzıman (6F35) biraz hantaldır.",
        price: 1300000,
        reliabilityScore: 79,
        totalIssues: 3,
        searchCount: 13000,
        issues: [
            {
                id: "mondeo-1",
                title: "Şanzıman Vuruntusu",
                description: "6F35 şanzımanın 2'den 3'e geçerken sarsması.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
            ...
            },
            {
                id: "mondeo-2",
                title: "Direksiyon Kutusu",
                description: "Direksiyon kutusu boşluğu ve tıkırtı sesi.",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "20.000 - 35.000 TL"
            },
            {
                id: "mondeo-3",
                title: "Su Pompası",
                description: "Devirdaim pompasının kaçırması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "90.000+ km",
                repairCost: "5.000 - 10.000 TL"
        ...
        buyingTips: [
            "Şanzıman yağı düzenli değişmiş mi?",
            "Sony ses sistemi var mı?"
        ]
    },
    {
        id: "honda-accord-2-0",
        ...
        years: "2008-2015",
        generation: "8. Nesil",
        expertNote: "Sanayiye sadece yağ değişimi için gidersin. Motor ve şanzıman mermidir. Ama direksiyon kutusu yağ kaçırır, o da Honda'nın tuzu biberi.",
        price: 850000,
        reliabilityScore: 92,
        totalIssues: 3,
        searchCount: 12000,
        issues: [
            ...
            },
            {
                id: "accord-3",
                title: "Kapı Kilit Motoru",
                description: "Kapıların kumandadan açılmaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 - 4.000 TL"
            ...
            {
                id: "accord-2",
                title: "VTEC Solenoid Contası",
                description: "Motorda yağ terlemesi.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "120.000+ km",
                repairCost: "1.000 TL"
        ...
        cons: [
            "Yüksek vergi (2.0 Motor)",
            "Şehir içi yakıt (12L)",
            "Arka diz mesafesi (D sınıfına göre dar)"
        ],
        buyingTips: [
            "Direksiyon kutusuna baktırın yağ kaçağı var mı?",
            "LPG ayarı düzgün mü?"
        ]
    },
    {
    ...
    },
    {
        ...
        expertNote: "301'in aynısı, sadece logosu farklı. Yeni motor (BlueHDi) AdBlue ister, biraz daha hassastır ama daha sessiz çalışır.",
        price: 780000,
        reliabilityScore: 83,
        totalIssues: 3,
        searchCount: 20000,
        issues: [
            {
                id: "celysee-2",
                title: "Triger Zinciri Sesi",
                description: "Şaşırmayın, 1.5 BlueHDi motorlarda eksantrik zinciri vardır ve ses yapar.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "celysee-1",
                title: "AdBlue Tankı",
                description: "AdBlue pompa arızası ve motorun çalışmaması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "20.000 - 35.000 TL"
            },
            {
                id: "celysee-3",
                title: "Multimedya",
                description: "Ekran dokunmatiğinin bozulması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "3.000 - 6.000 TL"
        ...
        buyingTips: [
            "AdBlue iptali yapılmış mı?",
            "Motor sesini soğukken dinleyin"
        ]
    },
    {
        ...
        years: "2011-2016",
        generation: "Mk1",
        expertNote: "Arazi aracı değil asfalt kamyonetidir. 2.0 BiTDI motor o kasaya biraz narin kalır, sıkıştırırsan hararet yapar, conta yakar. V6 olanı makbuldür.",
        price: 1100000,
        reliabilityScore: 70,
        totalIssues: 4,
        searchCount: 15000,
        issues: [
            {
                id: "amarok-1",
                title: "Turbo Hortumu",
                description: "Turbo hortumunun patlaması ve çekiş kaybı (Kronik).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "3.000 - 6.000 TL"
            },
            {
                ...
                description: "Otomatik şanzımanın arazi veya yükte ısınması.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "Zorlu şartlar",
                repairCost: "Yağ Soğutucu Değişimi"
            },
            {
                id: "amarok-2",
                title: "EGR Soğutucusu",
                description: "Su eksiltme ve motor arıza lambası.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "amarok-4",
                title: "Volan Sesi",
                description: "Çift kütleli volan arızası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "20.000 - 35.000 TL"
    ...
    },
    {
        ...
        brand: "Ford",
        model: "Ranger",
        variant: "3.2 / 2.0 Wildtrak",
        years: "2015-2022",
        generation: "T6",
        expertNote: "Kamyonetlerin kralı. 3.2 motorlusu asfaltı ağlatır ama mazotu içer (13-15L). 2.0 Bi-Turbo olanları daha makuldür ama onda da AdBlue derdi var. Şanzıman (10 ileri) bazen kararsız kalır.",
        price: 1500000,
        reliabilityScore: 82,
        totalIssues: 3,
        searchCount: 18000,
        issues: [
            {
                id: "ranger-3",
                title: "Turbo Islığı",
                description: "3.2 motorlarda turbo sesi (Karakteristik olabilir ama artarsa riskli).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "10.000 - 20.000 TL"
            ...
            {
                id: "ranger-1",
                title: "AdBlue Isıtıcı",
                description: "2.0 EcoBlue motorlarda AdBlue deposu arızası.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "15.000 - 25.000 TL"
        ...
        pros: [
            "Gerçek arazi canavarı",
            "Heybet",
            "Donanım (Wildtrak)"
        ],
        cons: [
            "Vergi (Kamyonet/Motor Hacmi)",
            "Şehir içi park sorunu",
            "Yakıt"
        ],
        buyingTips: [
            "Ağır off-road görmüş mü? Alt korumalar ezik mi?"
        ]
    },
    {
    ...
    },
    {
        ...
        brand: "Fiat",
        model: "500X",
        variant: "1.6 MultiJet Cross",
        years: "2015-2023",
        generation: "334",
        expertNote: "Jeep Renegade'in İtalyan ikizi. Alt yapısı aynıdır. Şekli şemali güzeldir, içi kalitelidir (Egea ile karıştırma). Elektroniği biraz narindir.",
        price: 950000,
        reliabilityScore: 81,
        totalIssues: 2,
        searchCount: 8500,
        issues: [
            {
                id: "500x-1",
                title: "Start-Stop",
                description: "Akü kaynaklı sistemin devre dışı kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Akü Değişimi"
            },
            {
                id: "500x-2",
                title: "Turbo Hortumu",
                description: "Turbo hortumunun çatlaması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "80.000+ km",
                repairCost: "3.000 - 6.000 TL"
    ...
    },
    {
        ...
        brand: "Fiat",
        model: "Egea",
        variant: "1.4 Fire Urban",
        years: "2015-2023",
        generation: "Type 356",
        expertNote: "Türkiye'nin milli aracı. 1.4 Fire motoru biraz yağ yakar ama parçası bakkalda bile satılır. 1.3 Multijet olanı yakıtı koklar. \"Teneke\" diyenlere bakma, işini en iyi yapan arabadır.",
        price: 700000,
        reliabilityScore: 89,
        totalIssues: 3,
        searchCount: 95000,
        issues: [
            {
                id: "egea-1",
                title: "Yağ Eksiltme",
                description: "1.4 Fire motorların karakteristik yağ yakma sorunu (Her 2000-3000 km'de 1 litre).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Sıfırdan itibaren",
                repairCost: "Yağ Ekleme Maliyeti"
            },
            {
                id: "egea-2",
                title: "City Modu",
                description: "DireksiyonCity modunun arızalanması ve sertleşmesi.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "5.000 - 10.000 TL"
            ...
            {
                id: "egea-3",
                title: "Krom Kaplamalar",
                description: "Ön panjur ve kapı kollarındaki kromların atması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Kozmetik"
        ...
        buyingTips: [
            "Taksi çıkması mı sorgulayın",
            "1.4 ise bagajda yağ bidonu var mı bakın (Varsa dürüst satıcıdır)."
        ]
    },
    {
        id: "renault-clio-4-1-5-dci",
        ...
        years: "2012-2019",
        generation: "IV",
        expertNote: "Şehir içi savaşçısı. 1.5 dCi motoru ölümsüzdür. Ama rüzgar sesi alır, trim sesi yapar. EDC şanzımanı biraz nazlıdır, korumaya alırsa yolda bırakmaz ama can sıkar.",
        price: 720000,
        reliabilityScore: 85,
        totalIssues: 3,
        searchCount: 65000,
        issues: [
            {
                id: "clio-2",
                title: "Start-Stop Arızası",
                description: "Start-Stop sisteminin \"Devre dışı\" uyarısı (Genelde akü kaynaklı).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Akü Değişimi"
            },
            {
                id: "clio-3",
                title: "EDC Beyni",
                description: "Otomatik şanzımanın ısınması veya vites geçiş hatası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "20.000 - 35.000 TL"
            },
            {
                id: "clio-1",
                title: "Rüzgar Sesi",
                description: "Ayna köklerinden (Kelebek camı) rüzgar sesi alması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Fitil/Silikon"
            }
        ],
        pros: [
            "Yakıt ekonomisi",
        ...
        buyingTips: [
            "Triger kayışı ne zaman değişmiş?",
            "EDC vites geçişlerini kontrol edin"
        ]
    },
    {
        ...
        years: "2014-2017",
        generation: "Mk5 Facelift (6C)",
        expertNote: "Küçük Golf. Sınıfının en kaliteli iç mekanına sahiptir. 1.2 TSI motor seri ve az yakar. DSG şanzıman yine baş rolde, iyi bakılmışsa sorun yok, hor kullanılmışsa kaç.",
        price: 850000,
        reliabilityScore: 82,
        totalIssues: 2,
        searchCount: 50000,
        issues: [
            {
                id: "polo-1",
                title: "DSG Mekatronik",
                description: "Vites geçişlerinde titreme ve ses.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "25.000 - 45.000 TL"
            },
            {
                id: "polo-2",
                title: "Devirdaim",
                description: "Su pompası arızası ve su eksiltme.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "90.000+ km",
                repairCost: "5.000 - 10.000 TL"
        ...
        cons: [
            "DSG riski",
            "Donanım eksikliği (Boş paketler)",
            "Fiyat yüksek"
        ],
        buyingTips: [
    ...
    {
        id: "honda-civic-fc5-1-6-ivtec",
        slug: "honda-civic-fc5-1-6-ivtec",
        brand: "Honda",
        model: "Civic",
        variant: "1.6 i-VTEC Eco",
        years: "2016-2021",
        generation: "FC5",
        expertNote: "LPG'li Japon tankı. Motoru (1.6 i-VTEC) ölümsüzdür. Ama \"göçük\" muhabbeti can sıkar. C sütununda dalgalanma var mı iyi bak. CVT şanzıman konforludur ama performans bekleme.",
        price: 1100000,
        reliabilityScore: 88,
        totalIssues: 3,
        searchCount: 40000,
        issues: [
            {
                id: "civic-1",
                title: "C Sütunu Göçüğü",
                description: "Arka kapı direklerinde (C sütunu) kendiliğinden oluşan dalgalanma.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik",
                repairCost: "Kaporta Onarımı / Değer Kaybı"
            },
            {
                id: "civic-2",
                title: "Klima Kondenser",
                description: "Klima radyatörünün delinmesi (Taş gelmesi veya üretim hatası).",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                id: "civic-3",
                title: "Direksiyon Kutusu",
                description: "Direksiyon kutusundan gelen tıkırtı sesi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "15.000 - 25.000 TL"
        ...
        cons: [
            "Kaporta boya kalitesi zayıf",
            "Yalıtım",
            "Performans (Atmosferik)"
        ],
        buyingTips: [
            "C sütununda işlem var mı?",
            "Klima soğutuyor mu?"
        ]
    },
    {
        ...
        years: "2007-2017",
        generation: "Mk1",
        expertNote: "Türk ailesinin, taksicinin kahrını çeken araba. 1.3 motoru az yakar ama kasa ağır gelir, yokuşta klima kapatırsın. Amortisör takozları kronik ses yapar.",
        price: 550000,
        reliabilityScore: 84,
        totalIssues: 3,
        searchCount: 35000,
        issues: [
            {
                id: "linea-3",
                title: "EGR Tıkanması",
                description: "Şehir içi kullanımda EGR valfinin dolması ve çekiş düşüklüğü.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "3.000 - 5.000 TL"
            },
            {
                id: "linea-1",
                title: "Zincir Sesi",
                description: "Triger zincirinin 120.000 km civarı ses yapması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "10.000 - 15.000 TL"
            },
            {
                id: "linea-2",
                title: "Amortisör Takozu",
                description: "Direksiyonu çevirirken gelen gıcırtı ve takırtı.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "2.000 - 4.000 TL"
    ...
    },
    {
        ...
        brand: "Fiat",
        model: "Doblo",
        variant: "1.6 MultiJet Premio",
        years: "2010-2022",
        generation: "Mk3/Mk4",
        expertNote: "Geniş ailenin veya esnafın gözbebeği. 1.6 motoru (105hp) bu kasayı uçurur. Arka süspansiyonu bağımsızdır, ticari gibi değil binek gibi yol tutar.",
        price: 750000,
        reliabilityScore: 87,
        totalIssues: 2,
        searchCount: 45000,
        issues: [
            {
                id: "doblo-1",
                title: "Amortisör Kulesi",
                description: "Ön amortisör kule bilyalarının ses yapması.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "2.000 - 3.000 TL"
            },
            {
                id: "doblo-2",
                title: "Partikül Filtresi",
                description: "DPF doluluğu ve rejenerasyon uyarısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Şehir içi",
                repairCost: "5.000 - 10.000 TL"
        ...
        cons: [
            "Arka kapı gergileri ses yapar",
            "Yakıt (1.6 içer)"
        ],
        buyingTips: [
            "Yük taşımış mı arka makas/yay durumuna bakın",
            "Motor üflemesi var mı?"
        ]
    },
    {
        id: "fiat-fiorino-1-3-multijet",
        ...
        years: "2008-2024",
        generation: "Mk3",
        expertNote: "Şehir içi ticari. Park sorunu yok, yakıtı koklar. Ama süspansiyon kütüktür, bozuk yolda böbrek taşını düşürür. 1.3 75hp biraz hantal kalır.",
        price: 600000,
        reliabilityScore: 88,
        totalIssues: 2,
        searchCount: 40000,
        issues: [
            {
                id: "fiorino-2",
                title: "Zincir Sesi",
                description: "1.3 Euro 5/6 motorlarda zincir uzaması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "120.000+ km",
                repairCost: "10.000 - 15.000 TL"
            },
            {
                id: "fiorino-1",
                title: "Amortisör Takozu",
                description: "Klasik Fiat ön takım sesi.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "2.000 - 3.000 TL"
        ...
        buyingTips: [
            "Şirket aracı mı motor kondisyonu nasıl?",
            "Ön lastiklerde aşınma var mı?"
        ]
    },
    {
        id: "fiat-punto-evo-1-3-multijet",
        ...
        brand: "Fiat",
        model: "Punto",
        variant: "1.3 MultiJet Evo",
        years: "2010-2013",
        generation: "Evo",
        expertNote: "Fiyatına göre alınabilecek en mantıklı araçlardan. İçi Egea'dan daha kalitelidir (Evo göğüs). City modu arızası meşhurdur.",
        price: 550000,
        reliabilityScore: 83,
        totalIssues: 3,
        searchCount: 25000,
        issues: [
            {
                ...
                description: "Direksiyon eps motorunun bozulması (Direksiyon taş gibi olur).",
                category: "elektronik",
                riskLevel: "HIGH",
                affectedKm: "Kronik",
                repairCost: "8.000 - 15.000 TL"
    ...
    },
    {
        ...
        brand: "Fiat",
        model: "500L",
        variant: "1.3 MultiJet Pop Star",
        years: "2012-2022",
        generation: "Mk1",
        expertNote: "Geniş, ferah, aile aracı. Ama o otomatik şanzıman (Dualogic) yok mu, vites geçişlerinde başını öne eğdirir. Yokuşta bazen kafası karışır.",
        price: 700000,
        reliabilityScore: 80,
        totalIssues: 3,
        searchCount: 12000,
        issues: [
            {
                id: "500l-1",
                title: "Dualogic Robot",
                description: "Yarı otomatik şanzıman robot yağ kaçağı ve vites hatası.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "20.000 - 35.000 TL"
            },
            {
                id: "500l-2",
                title: "Turbo Hortumu",
                description: "Turbo hortumunun patlaması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "3.000 - 5.000 TL"
        ...
        cons: [
            "Dualogic şanzıman",
            "Tasarım (Zevk meselesi)",
            "Ağır olduğu için çok yakar"
        ],
        buyingTips: [
            "Otomatikse vites geçişlerini yokuşta deneyin",
            "Cam tavan perdesi çalışıyor mu?"
        ]
    },
    {
        id: "renault-megane-4-1-3-tce",
        ...
        years: "2016-2023",
        generation: "IV",
        expertNote: "Sınıfının en yakışıklısı. 1.3 TCe motor Mercedes ortaklığıyla üretilmiştir, performansı efsanedir. EDC şanzıman konforludur ama 4. vitesten sonra bazen ses yapabilir. Trim seslerine hazırlıklı olun.",
        price: 950000,
        reliabilityScore: 86,
        totalIssues: 3,
        searchCount: 70000,
        issues: [
            {
                id: "megane-2",
                title: "EDC Kavrama",
                description: "Yoğun trafikte şanzımanın ısınması ve titreme yapması.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "25.000 - 40.000 TL"
            },
            {
                id: "megane-3",
                title: "R-Link Ekran",
                description: "Multimedya ekranının donması veya siyah ekran vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Değişim"
            },
            {
                id: "megane-1",
                title: "Trim Sesi",
                description: "B sütunu, kapı içleri ve konsoldan gelen tıkırtılar.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Kozmetik / İzolasyon"
            }
        ],
        pros: [
            "Tasarım",
        ...
        cons: [
            "Arka diz mesafesi (Sedan hariç)",
            "Trim sesleri",
            "Yalıtım (Rüzgar)"
        ],
        buyingTips: [
            "Şanzıman yağı değişmiş mi?",
            "C sütununda (Sedan) göçük var mı?"
        ]
    },
    {
        id: "renault-symbol-1-5-dci",
        ...
        years: "2013-2021",
        generation: "III",
        expertNote: "Türkiye şartlarının en dayanıklı aracı. Yakıtı koklar, parçası her yerde bulunur. Konfor beklemeyin, A noktasından B noktasına en ucuza götürür.",
        price: 550000,
        reliabilityScore: 90,
        totalIssues: 2,
        searchCount: 40000,
        issues: [
            {
                id: "symbol-1",
                title: "Enjektör Sesi",
                description: "Soğuk havalarda enjektörlerin şakırdaması (Yakıt seçer).",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "5.000 - 10.000 TL"
            },
            {
                ...
                description: "Klima açıldığında motordan gelen uğultu.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik",
                repairCost: "8.000 - 15.000 TL"
        ...
        buyingTips: [
            "Taksi çıkması mı kesin sorgulayın",
            "Motor üflemesi var mı yağ kapağını açıp bakın"
        ]
    },
    {
        id: "renault-taliant-1-0-turbo",
        ...
        brand: "Renault",
        model: "Taliant",
        variant: "1.0 Turbo X-Tronic",
        years: "2021-2024",
        generation: "I",
        expertNote: "Symbol'ün modern hali. Dacia Logan altyapısını kullanır. CVT şanzıman (X-Tronic) şehir içinde rahattır ama performansı törpüler. Yalıtımı Symbol'den hallicedir.",
        price: 800000,
        reliabilityScore: 82,
        totalIssues: 3,
        searchCount: 20000,
        issues: [
            {
                ...
                description: "Alt devirlerde cansızlık ve ani hızlanmada kararsızlık.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
            },
            {
                ...
                description: "Ekranın sürüş esnasında kapanıp açılması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Servis Güncellemesi"
            },
            {
                id: "taliant-3",
                title: "Yakıt Pompası",
                description: "Depodan gelen uğultu sesi.",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Garanti / Değişim"
            }
        ],
        pros: [
            "Model yılı yeni",
            "Geniş bagaj",
            "Otomatik vites konforu"
        ],
        cons: [
            "Malzeme kalitesi",
            "Rüzgar sesi",
        ...
        buyingTips: [
            "CVT şanzıman güncellemesi yapılmış mı?",
            "Kapı fitillerini kontrol edin"
        ]
    },
    {
        ...
        years: "2020-2024",
        generation: "II",
        expertNote: "B-SUV segmentinin en şık araçlarından. İç mekanı Clio 5 ile benzer ama daha ferah. 1.3 motor performansı çok iyidir. Elektronik aksamı bazen nazlıdır.",
        price: 1100000,
        reliabilityScore: 85,
        totalIssues: 2,
        searchCount: 30000,
        issues: [
            {
                id: "captur-1",
                title: "Start-Stop",
                description: "Sistemin devreye girmemesi (Akü şarj durumuyla ilgili).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Kış ayları",
                repairCost: "Akü Şarjı / Değişimi"
            },
            {
                id: "captur-2",
                title: "Fren Sesi",
                description: "Geri geri giderken balatalardan ses gelmesi.",
                category: "fren",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Temizlik"
        ...
        buyingTips: [
            "Elektronik park freni çalışıyor mu?",
            "Multimedya ekranı tepkisel mi?"
        ]
    },
    {
        id: "renault-austral-1-3-tce",
        ...
        brand: "Renault",
        model: "Austral",
        variant: "1.3 Mild Hybrid Esprit Alpine",
        years: "2022-2024",
        generation: "I",
        expertNote: "Renault'un premium atağı. Malzeme kalitesi üst düzey. Android tabanlı multimedya sistemi çok iyi çalışır ama bazen donabilir. Hibrit sistemi yakıtı gerçekten düşürür.",
        price: 1600000,
        reliabilityScore: 88,
        totalIssues: 2,
        searchCount: 25000,
        issues: [
            {
                id: "austral-2",
                title: "Trim Sesi (Cam Tavan)",
                description: "Bozuk yollarda panoramik cam tavandan gelen çıtırtı.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "İzolasyon Spreyi"
            },
            {
                id: "austral-1",
                title: "Ekran Donması",
                description: "OpenR Link ekranının nadiren tepkisiz kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Resetleme / Güncelleme"
            }
        ],
        pros: [
            "Google Multimedya",
        ...
        cons: [
            "Fiyat",
            "Bagaj (Hibrit bataryası küçültüyor)",
            "Sert sürüş"
        ],
        buyingTips: [
            "Multimedya sistemini kurcalayın",
            "Cam tavan perdesi sorunsuz mu?"
        ]
    },
    {
    ...
    },
    {
        ...
        brand: "Volkswagen",
        model: "Passat",
        variant: "1.6 TDI Impression",
        years: "2015-2023",
        generation: "B8",
        expertNote: "Türk erkeğinin hayali, \"Aşiret Paket\". Konfor, prestij ve ikinci el değeri. 1.6 TDI motor biraz seslidir ama az yakar. DSG şanzıman her zamanki gibi risk faktörüdür.",
        price: 1300000,
        reliabilityScore: 86,
        totalIssues: 3,
        searchCount: 100000,
        issues: [
            {
                id: "passat-3",
                title: "Devirdaim",
                description: "Elektronik devirdaim pompasının arızalanması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "90.000+ km",
                repairCost: "8.000 - 15.000 TL"
            },
            {
                id: "passat-1",
                title: "DSG Kavrama",
                description: "7 ileri kuru kavrama DSG titreme ve vuruntu.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "30.000 - 50.000 TL"
            },
            {
                id: "passat-2",
                title: "Volan Sesi",
                description: "Çift kütleli volanın ses yapması (Şıkırtı).",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
        ...
        buyingTips: [
            "DSG geçmişine bakın (Kavrama/Mekatronik değişmiş mi?)",
            "Triger ve devirdaim değişmiş mi?"
        ]
    },
    {
        id: "volkswagen-golf-7-1-4-tsi",
        ...
        years: "2012-2020",
        generation: "Mk7",
        expertNote: "C segmentinin referans modeli. Malzeme kalitesi, yalıtım ve sürüş dinamikleri en iyisidir. 1.4 TSI 125/150hp motorlar çok seridir. \"Golf, Golf'tür.\"",
        price: 950000,
        reliabilityScore: 84,
        totalIssues: 3,
        searchCount: 85000,
        issues: [
            {
                id: "golf-3",
                title: "Kapı Kilitleri",
                description: "Kapı kilit mekanizmasının bozulması (Kapı açılmaması).",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 - 4.000 TL"
            },
            {
                id: "golf-1",
                title: "DSG Mekatronik",
                description: "Mekatronik kart arızası veya basınç tüpü gevşemesi.",
                category: "sanziman",
                riskLevel: "CRITICAL",
                affectedKm: "Aniden olabilir",
                repairCost: "30.000 - 60.000 TL"
            },
            {
                id: "golf-2",
                title: "Sunroof Çatlağı",
                description: "Sunroof çerçevesinin çatlaması ve içeri su alması.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik (Mk7)",
                repairCost: "15.000 - 25.000 TL (Çerçeve Değişimi)"
            }
        ],
        pros: [
            "Kalite",
        ...
        buyingTips: [
            "Sunroof etrafında su lekesi var mı?",
            "DSG kararlı çalışıyor mu?"
        ]
    },
    {
        id: "volkswagen-tiguan-1-5-tsi",
        ...
        brand: "Volkswagen",
        model: "Tiguan",
        variant: "1.5 TSI Act Highline",
        years: "2016-2023",
        generation: "Mk2",
        expertNote: "Ailelerin favori SUV'u. Geniş, ferah ve kaliteli. 1.5 TSI motor 150 beygirle kasayı rahat taşır. Yakıtı biraz üzer (8-10L). DSG şanzımana dikkat edilmeli.",
        price: 1500000,
        reliabilityScore: 85,
        totalIssues: 3,
        searchCount: 60000,
        issues: [
            {
                id: "tiguan-1",
                title: "Kangaroo Etkisi",
                description: "Soğuk motorda ilk kalkışta silkeleme yapması (1.5 TSI kronik).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Sıfırdan itibaren",
                repairCost: "Yazılım Güncellemesi"
            ...
            {
                id: "tiguan-2",
                title: "Sunroof Çerçevesi",
                description: "Sunroof kasasından ses gelmesi ve su sızdırması.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "tiguan-3",
                title: "DSG Mekatronik",
                description: "Vites geçişlerinde kararsızlık ve titreme.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "30.000 - 50.000 TL"
        ...
        buyingTips: [
            "Soğukken ilk kalkışta silkeleme var mı?",
            "Sunroof perdesi ve fitilleri sağlam mı?"
        ]
    },
    {
        id: "volkswagen-troc-1-5-tsi",
        ...
        years: "2018-2024",
        generation: "Mk1",
        expertNote: "Golf'ün SUV hali ama içi Golf kadar kaliteli değil (Sert plastikler). Sürüşü çok keyiflidir. Gençlerin yeni gözdesi.",
        price: 1350000,
        reliabilityScore: 83,
        totalIssues: 2,
        searchCount: 40000,
        issues: [
            {
                id: "troc-1",
                title: "Bagaj Amortisörü",
                description: "Elektrikli bagajın bazen kapanmaması veya ses yapması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "2.000 - 5.000 TL"
            },
            {
                id: "troc-2",
                title: "Trim Sesleri",
                description: "Kapı içlerinden ve göğüsten gelen plastik sesleri.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "İzolasyon"
        ...
        cons: [
            "Malzeme kalitesi (Plastik)",
            "Arka yaşam alanı dar"
        ],
        buyingTips: [
            "Bagaj kapağı düzgün açılıp kapanıyor mu?",
            "DSG vites geçişleri sarsıntısız mı?"
        ]
    },
    {
        id: "volkswagen-caddy-2-0-tdi",
        ...
        years: "2020-2024",
        generation: "Mk5",
        expertNote: "Ticari değil binek konforunda. Yeni kasada makas yerine helezon yay var, zıplatmaz. 2.0 TDI motor çok güçlüdür. Panoramik cam tavan harika bir hava katar.",
        price: 1100000,
        reliabilityScore: 88,
        totalIssues: 3,
        searchCount: 50000,
        issues: [
            {
                id: "caddy-1",
                title: "AdBlue Hatası",
                description: "AdBlue sisteminin kristalleşip tıkanması.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Şehir içi",
                repairCost: "10.000 - 20.000 TL"
            ...
            },
            {
                id: "caddy-2",
                title: "Hayalet Ekran",
                description: "Dijital göstergenin kararması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Garanti / Değişim"
    ...
    },
    {
        ...
        years: "2017-2024",
        generation: "Mk1",
        expertNote: "CC'nin varisi. Tasarımı kafa çevirtir. Çerçevesiz camlar havalıdır ama rüzgar sesi yapar. 1.5 motor bu kasaya biraz zayıf kalır ama vergisi avantajlıdır.",
        price: 1800000,
        reliabilityScore: 85,
        totalIssues: 2,
        searchCount: 20000,
        issues: [
            {
                id: "arteon-1",
                title: "Rüzgar Sesi",
                description: "Yüksek hızlarda çerçevesiz camlardan rüzgar sesi gelmesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "120+ km/s",
                repairCost: "Fitil Ayarı"
            },
            {
                id: "arteon-2",
                title: "Sunroof Sesi",
                description: "Sunroof mekanizmasının esnemesi ve tıkırtı yapması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Bakım / Yağlama"
        ...
        buyingTips: [
            "Camlar tam kapanıyor mu?",
            "Sunroof açıkken ses yapıyor mu?"
        ]
    },
    {
        ...
        years: "2015-2024",
        generation: "T6",
        expertNote: "VIP taşımacılığın lideri. Konforlu ve sessizdir. 2.0 TDI motor uzun ömürlüdür ama bakımsızsa üzer. DSG şanzıman bu ağırlıkta biraz daha risklidir.",
        price: 1400000,
        reliabilityScore: 87,
        totalIssues: 3,
        searchCount: 45000,
        issues: [
            {
                id: "transporter-1",
                title: "Volan Sesi",
                description: "Çift kütleli volanın rolantide ses yapması.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "transporter-3",
                title: "Sürgülü Kapı",
                description: "Otomatik kapı halatının kopması.",
                category: "govde",
                riskLevel: "MEDIUM",
            ...
            },
            {
                id: "transporter-2",
                title: "EGR Soğutucu",
                description: "EGR soğutucusunun su kaçırması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "150.000+ km",
                repairCost: "10.000 - 15.000 TL"
        ...
        buyingTips: [
            ...
            "EGR iptal edilmiş mi?"
        ]
    },
    {
        id: "vw-tcross-1-0-tsi",
        slug: "vw-tcross-1-0-tsi",
        brand: "Volkswagen",
        model: "T-Cross",
        ...
        issues: [
            {
                id: "tcross-2",
                title: "Trim Sesi",
                description: "Bozuk yollarda bagaj ve kapılardan gelen sesler.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "İzolasyon"
            },
            {
                id: "tcross-1",
                title: "Start-Stop",
                description: "Start-Stop sisteminin devreye girmemesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Akü kaynaklı",
                repairCost: "Akü Değişimi"
    ...
    },
    {
        ...
        years: "2021-2024",
        generation: "Mk1",
        expertNote: "Nivus adıyla bilinen Coupe-SUV. T-Cross'tan daha sportif görünür ama altyapısı aynıdır. Bagajı şaşırtıcı derecede geniştir. Yalıtımı sınıf ortalamasındadır.",
        price: 1250000,
        reliabilityScore: 85,
        totalIssues: 2,
        searchCount: 30000,
        issues: [
            {
                id: "taigo-1",
                title: "Yağ Eksiltme",
                description: "1.0 TSI motorlarda nadiren görülen yağ seviyesi uyarısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Rodaj süresi",
                repairCost: "Yağ Ekleme"
            },
            {
                id: "taigo-2",
                title: "Rüzgar Sesi",
                description: "Ayna ve B sütunundan rüzgar sesi alması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "110+ km/s",
                repairCost: "Fitil Ayarı"
    ...
    },
    {
        ...
        years: "2012-2019",
        generation: "A5",
        expertNote: "Efsane Vosvos'un torunu. Tarzı yeter. 1.2 TSI motor şehiriçi için yeterlidir. Çerçevesiz camları havalıdır. İkinci eli her zaman canlıdır.",
        price: 900000,
        reliabilityScore: 83,
        totalIssues: 3,
        searchCount: 15000,
        issues: [
            {
                id: "beetle-3",
                title: "Turbo Wastegate",
                description: "Turbodan gelen şırıltı sesi (Performansı etkilemez ama rahatsız eder).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Klips Takılması"
            },
            {
                id: "beetle-1",
                title: "Cam Krikosu",
                description: "Çerçevesiz cam mekanizmasının bozulması veya ses yapması.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Kronik",
                repairCost: "3.000 - 5.000 TL"
            },
            {
                id: "beetle-2",
                title: "DSG Kavrama",
                description: "Klasik 7 ileri DSG titreme sorunu.",
                category: "sanziman",
                riskLevel: "HIGH",
                affectedKm: "80.000+ km",
                repairCost: "30.000 - 50.000 TL"
    ...
    },
    {
        ...
        years: "2021-2024",
        generation: "GN",
        expertNote: "Civic'in küçük kardeşi. İçi şaşırtıcı derecede geniştir. 1.5 atmosferik motor ve CVT şanzıman ikilisi sorunsuzdur, sanayi yolu unutturur. Ama yalıtım zayıftır.",
        price: 950000,
        reliabilityScore: 92,
        totalIssues: 2,
        searchCount: 35000,
        issues: [
            {
                id: "city-1",
                title: "Yol Sesi",
                description: "Yalıtım zayıflığı nedeniyle içeriye fazla yol ve rüzgar sesi alması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "İzolasyon (Opsiyonel)"
            },
            {
                id: "city-2",
                title: "Boya İnceliği",
                description: "Kaporta boyasının taş izlerine karşı hassas olması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Rötuş / Kaplama"
            }
        ],
        pros: [
            "Sorunsuzluk",
            "Geniş arka diz mesafesi",
            "Yakıt ekonomisi (LPG uyumu)"
        ],
        cons: [
            "Yalıtım",
            "İnce kaporta",
        ...
        buyingTips: [
            "Kaputta taş izi var mı?",
            "CVT şanzıman yağı değişmiş mi?"
        ]
    },
    {
        id: "honda-crv-hybrid",
        ...
        brand: "Honda",
        model: "CR-V",
        variant: "2.0 i-MMD Hybrid Executive",
        years: "2019-2023",
        generation: "Mk5",
        expertNote: "Gerçek bir aile SUV'u. Hibrit sistemi çok verimlidir, şehir içinde elektrikle sessizce gider. Konfor odaklıdır. 4 çeker sistemi güven verir.",
        price: 2200000,
        reliabilityScore: 90,
        totalIssues: 2,
        searchCount: 20000,
        issues: [
            {
                id: "crv-2",
                title: "Motor Sesi",
                description: "Yüksek devirde motorun kabine fazla ses vermesi (CVT karakteri).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Yüksek Hız",
                repairCost: "Normal Karakterteristik"
            },
            {
                id: "crv-1",
                title: "Akü Boşalması",
                description: "Uzun süre (1-2 hafta) çalıştırılmazsa 12V aküsünün bitmesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Park halinde",
                repairCost: "Takviye / Akü Değişimi"
            }
        ],
        pros: [
            "Yakıt ekonomisi (Şehir içi)",
            "Geniş ve konforlu",
        ...
        cons: [
            "Fiyat",
            "Motor sesi (Dip gazda)",
            "Multimedya eski yüzlü"
        ],
        buyingTips: [
            "Hibrit batarya sağlığı testi yapıldı mı?",
            "Tüm camlar ve sunroof sorunsuz mu?"
        ]
    },
    {
        id: "honda-jazz-1-3-ivtec",
        slug: "honda-jazz-1-3-ivtec",
        brand: "Honda",
        model: "Jazz",
        variant: "1.5 e:HEV Hybrid",
        years: "2020-2024",
        generation: "Mk4",
        expertNote: "Küçük dev. İç hacmi ve pratikliği (Sihirli koltuklar) inanılmazdır. Hibrit sistemi ile şehir içinde yakıtı adeta koklar. Sorunsuzluk abidesidir.",
        price: 1050000,
        reliabilityScore: 94,
        totalIssues: 1,
        searchCount: 15000,
        issues: [
            {
                id: "jazz-1",
                title: "Multimedya",
                description: "Ekran arayüzünün bazen yavaşlaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Güncelleme"
        ...
        pros: [
            "Magic Seats (Sihirli Koltuklar)",
            "Yakıt tüketimi (3.5L)",
            "Görüş açısı"
        ],
        cons: [
            "Fiyat (Sınıfına göre)",
            "Otoyol performansı (Hızlanma)"
        ],
        buyingTips: [
            "Sihirli koltuk mekanizması çalışıyor mu?",
            "Bakımları yetkili serviste mi yapılmış?"
        ]
    },
    {
        id: "honda-civic-fb7-1-6-eco",
        slug: "honda-civic-fb7-1-6-eco",
        brand: "Honda",
        model: "Civic FB7",
        ...
        years: "2012-2016",
        generation: "FB7",
        expertNote: "Türk halkının en sevdiği kasalardan. \"Japon Mercedes'i\" lakabı takılmıştır. LPG ile uyumu kusursuzdur. Otomatik şanzımanı (5 ileri tam otomatik) tork konvertörlüdür, bozulmaz.",
        price: 900000,
        reliabilityScore: 90,
        totalIssues: 3,
        searchCount: 55000,
        issues: [
            {
                id: "fb7-1",
                title: "Direksiyon Kutusu",
                description: "Direksiyon kutusundan gelen tıkırtı sesi (Honda klasiği).",
                category: "suspansiyon",
                riskLevel: "MEDIUM",
                affectedKm: "60.000+ km",
                repairCost: "10.000 - 15.000 TL"
            },
            {
                id: "fb7-3",
                title: "Koltuk Kumaşı",
                description: "Bej renk koltuklarda leke tutma ve deformasyon.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kullanıma bağlı",
                repairCost: "Detaylı Temizlik / Kılıf"
            },
            {
                id: "fb7-2",
                title: "Fren Diski",
                description: "Disklerin çabuk yamulması ve frende titreme.",
                category: "fren",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "3.000 - 5.000 TL"
        ...
        cons: [
            "Yalıtım (Yol sesi)",
            "Boya kalitesi (İnce)",
            "Bagaj kolları yer kaplar"
        ],
        buyingTips: [
            "Direksiyon kutusunda boşluk/ses var mı?",
            "LPG sistemi bakımlı mı?"
        ]
    },
    {
        id: "honda-hrv-1-5-ivtec",
        slug: "honda-hrv-1-5-ivtec",
        brand: "Honda",
        model: "HR-V",
        variant: "1.5 i-VTEC Executive",
        years: "2015-2021",
        generation: "RU",
        expertNote: "Gizli kahraman. İçi göründüğünden geniştir. 1.5 atmosferik motor performans vermez ama sorun da çıkarmaz. CVT şanzıman konforludur.",
        price: 1100000,
        reliabilityScore: 88,
        totalIssues: 2,
        searchCount: 22000,
        issues: [
            {
                id: "hrv-2",
                title: "CVT Sesi",
                description: "Şanzımanın uğultulu çalışması (Karakteristik ama rahatsız edici).",
                category: "sanziman",
                riskLevel: "LOW",
            ...
            },
            {
                id: "hrv-1",
                title: "Start-Stop",
                description: "Sistemin devreye girmemesi hatası.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Akü kaynaklı",
                repairCost: "Akü Değişimi"
        ...
        buyingTips: [
            "Start-Stop çalışıyor mu?",
            "Klima paneli (Dokunmatik) sorunsuz mu?"
        ]
    },
    {
        id: "toyota-corolla-hybrid",
        ...
        years: "2019-2024",
        generation: "E210",
        expertNote: "Dünyanın en çok satan arabası. Hibrit teknolojisinin zirvesi. Şehir içinde %50 elektrikle gidersiniz. Sessiz, konforlu ve güvenli. Performans arayanı üzer.",
        price: 1200000,
        reliabilityScore: 93,
        totalIssues: 2,
        searchCount: 90000,
        issues: [
            {
                id: "corolla-1",
                title: "Rüzgar Sesi",
                description: "110-120 km/s hızlardan sonra A sütunu ve aynalardan rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Fitil Takviyesi"
            },
            {
                id: "corolla-2",
                title: "Fren Balata Sesi",
                description: "Frenlerden gelen tiz ses (Toz birikmesi).",
                category: "fren",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Temizlik"
        ...
        cons: [
            "CVT şanzıman sesi (Gazlayınca)",
            "Arka tavan basık",
            "Bagaj (Hibrit)"
        ],
        buyingTips: [
            "Hibrit garantisi devam ediyor mu (Onat)?",
            "Lastik durumu (Düşük yuvarlanma dirençli mi?)"
        ]
    },
    {
        id: "toyota-chr-1-8-hybrid",
        ...
        brand: "Toyota",
        model: "C-HR",
        variant: "1.8 Hybrid Diamond",
        years: "2016-2023",
        generation: "AX10",
        expertNote: "Tasarım harikası. Fütüristik çizgileriyle hala güncel. Sürüş dinamikleri bir SUV'dan çok Hatchback gibidir. Arka koltuk klostrofobik olabilir.",
        price: 1150000,
        reliabilityScore: 91,
        totalIssues: 2,
        searchCount: 45000,
        issues: [
            {
                ...
                description: "Bazı serilerde ön camın gerilmeden dolayı kendiliğinden çatlaması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "2016-2018 modeller",
                repairCost: "Cam Değişimi"
            },
            {
                id: "chr-2",
                title: "Boyunluk Sesi",
                description: "Koltuk kafalıklarından gelen trim sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "İzolasyon"
        ...
        cons: [
            "Arka camlar küçük (Karanlık)",
            "Bagaj",
            "Motor sesi"
        ],
        buyingTips: [
            "Ön camda çatlak veya değişim var mı?",
            "Arka kapı kolu mekanizması sağlam mı?"
        ]
    },
    {
        id: "toyota-yaris-hybrid",
        ...
        years: "2020-2024",
        generation: "XP210",
        expertNote: "Şehir içi park sorununun ilacı. Hibrit sistemi o kadar verimli ki benzinliği unutursunuz. İçi biraz dar ama kalitesi B sınıfı için iyidir. \"Avrupa'da Yılın Otomobili\" seçilmiştir.",
        price: 950000,
        reliabilityScore: 95,
        totalIssues: 1,
        searchCount: 30000,
        issues: [
            {
                id: "yaris-1",
                title: "Arka Kapı Açısı",
                description: "Arka kapıların dar açılması nedeniyle iniş biniş zorluğu.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
        ...
        buyingTips: [
            "Arka koltuklara oturdunuz mu (Darlık testi)?",
            "Bakımları yetkili serviste mi?"
        ]
    },
    {
        id: "toyota-corolla-cross-hybrid",
        ...
        brand: "Toyota",
        model: "Corolla Cross",
        variant: "1.8 Hybrid Passion",
        years: "2022-2024",
        generation: "XG10",
        expertNote: "Corolla'nın SUV olmuş hali, tam olarak ne eksik ne fazla. Pratik, sorunsuz ve ekonomik. Ancak iç mekan kalitesi Corolla Sedan'dan bir tık aşağıda hissettirebilir.",
        price: 1450000,
        reliabilityScore: 92,
        totalIssues: 2,
        searchCount: 35000,
        issues: [
            {
                id: "cross-1",
                title: "Multimedya",
                description: "Ekran çözünürlüğü ve kamerasının rakiplerine göre zayıf kalması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Karakteristik",
                repairCost: "Yok"
            },
            {
                id: "cross-2",
                title: "Rüzgar Sesi",
                description: "Yüksek yapısı nedeniyle otoyol hızlarında rüzgar sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "110+ km/s",
                repairCost: "İzolasyon"
        ...
        buyingTips: [
            "Multimedya ekran kalitesi sizi tatmin ediyor mu?",
            "Yalıtım testi yapın"
        ]
    },
    {
    ...
    },
    {
        ...
        brand: "Skoda",
        model: "Octavia",
        variant: "1.5 TSI e-Tec Elite",
        years: "2020-2024",
        generation: "Mk4",
        expertNote: "C segmentinin en genişi. Bagajı devasadır (600L). 1.5 e-Tec motor hafif hibrit desteğiyle çok az yakar. Konforu üst düzeydir. Yazılım sorunları ilk serilerde can sıkıcıydı.",
        price: 1350000,
        reliabilityScore: 88,
        totalIssues: 2,
        searchCount: 50000,
        issues: [
            {
                id: "octavia-1",
                title: "Yazılım ve Multimedya Sorunları",
                description: "Ekran donması, yeniden başlaması ve asistan sistemlerinin hata vermesi.",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Yazılım",
                repairCost: "Güncelleme"
            ...
            {
                id: "octavia-2",
                title: "Travel Assist Hatası",
                description: "Direksiyon simidindeki sensör arızası nedeniyle sürekli uyarı vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Direksiyon Değişimi"
            },
            {
                id: "octavia-3",
                title: "12V Akü Problemi",
                description: "Mild Hybrid sistemine rağmen 12V akünün bitmesi (Yazılım kaynaklı).",
                category: "elektronik",
                riskLevel: "MEDIUM",
                affectedKm: "Rastgele",
                repairCost: "Akü Değişimi"
        ...
        buyingTips: [
            "Multimedya yazılımı güncel mi?",
            "Hafif hibrit batarya durumu nedir?"
        ]
    },
    {
        id: "skoda-superb-1-5-tsi",
        ...
        years: "2015-2023",
        generation: "Mk3",
        expertNote: "Makam aracı konforunu Passat'tan daha ucuza sunar. İç hacmi \"salon salomanje\" gibidir. 1.5 motor bu kasayı zorlanmadan taşır.",
        price: 1600000,
        reliabilityScore: 90,
        totalIssues: 2,
        searchCount: 60000,
        issues: [
            {
                id: "superb-1",
                title: "Krom Çıta",
                description: "Cam kenarındaki krom çıtaların zamanla solması veya kalkması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Güneş etkisi",
                repairCost: "Kozmetik"
            },
            {
                id: "superb-2",
                title: "Fren Diski",
                description: "Ağır kasa nedeniyle fren disklerinin çabuk yıpranması.",
                category: "fren",
                riskLevel: "LOW",
                affectedKm: "40.000+ km",
                repairCost: "3.000 - 5.000 TL"
        ...
        cons: [
            "Büyük boyutlar (Park)",
            "DSG",
            "İkinci el (Passat kadar hızlı değil)"
        ],
        buyingTips: [
            "Krom detaylar temiz mi?",
            "DSG kavraması değişmiş mi?"
        ]
    },
    {
        id: "skoda-kamiq-1-0-tsi",
        ...
        years: "2019-2024",
        generation: "Mk1",
        expertNote: "B-SUV segmentinin en akıllıcası. İçi sınıfına göre çok geniştir. 1.0 motor yeterlidir. Genç aileler için idealdir.",
        price: 1200000,
        reliabilityScore: 89,
        totalIssues: 2,
        searchCount: 30000,
        issues: [
            {
                id: "kamiq-1",
                title: "Kapı Fitili",
                description: "Kapı fitillerinden bozuk yolda gıcırtı gelmesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Sprey / Fitil Değişimi"
            },
            {
                id: "kamiq-2",
                title: "Start-Stop",
                description: "Sistemin nadiren hata vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Akü",
                repairCost: "Şarj / Değişim"
            }
        ],
        pros: [
            "Geniş iç mekan",
            "Pratik çözümler (Simply Clever)",
            "Fiyat/Performans"
        ],
        cons: [
            "Sert plastikler",
        ...
        buyingTips: [
            "Kapı fitillerinden ses geliyor mu?",
            "Multimedya sorunsuz çalışıyor mu?"
        ]
    },
    {
        id: "skoda-scala-1-0-tsi",
        ...
        years: "2019-2024",
        generation: "Mk1",
        expertNote: "Golf ile Polo arasında kalmış bir model. Rapid'in yerini aldı. Bagajı Golf'ten büyüktür. Fiyatı makuldür.",
        price: 1100000,
        reliabilityScore: 87,
        totalIssues: 2,
        searchCount: 20000,
        issues: [
            {
                id: "scala-1",
                title: "Trim Sesi",
                description: "Konsol ve kapı içlerinden gelen plastik sesi.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "İzolasyon"
            },
            {
                id: "scala-2",
                title: "Klima Paneli",
                description: "Dijital klimanın geç tepki vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Yazılım",
                repairCost: "Yok"
    ...
    {
        id: "skoda-kodiaq-2-0-tdi",
        slug: "skoda-kodiaq-2-0-tdi",
        brand: "Skoda",
        model: "Kodiaq",
        variant: "2.0 TDI Prestige",
        years: "2017-2024",
        generation: "Mk1",
        expertNote: "Skoda'nın ayısı. Devasa, 7 kişilik (opsiyonel) ve heybetli. 2.0 TDI motorla tam bir uzun yol canavarıdır. Şehir içinde park etmek zordur.",
        price: 2500000,
        reliabilityScore: 91,
        totalIssues: 2,
        searchCount: 25000,
        issues: [
            {
                id: "kodiaq-1",
                title: "Kapı Koruması",
                description: "Kapı açılınca çıkan plastik korumanın mekanizmasının bozulması.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Kronik",
                repairCost: "Mekanizma Değişimi"
            ...
            {
                id: "kodiaq-2",
                title: "Sunroof Gideri",
                description: "Sunroof su giderlerinin tıkanıp içeri su alması.",
                category: "govde",
                riskLevel: "MEDIUM",
                affectedKm: "Bakımsızsa",
                repairCost: "Temizlik"
        ...
        buyingTips: [
            "Kapı kenar korumaları çalışıyor mu?",
            "Sunroof etrafında ıslaklık var mı?"
        ]
    },
    {
        ...
        issues: [
            {
                id: "egea-cross-16-1",
                title: "DPF Tıkanıklığı",
                description: "Şehir içi ağırlıklı kullanımda dizel partikül filtresinin dolması ve rejenerasyon uyarısı.",
                category: "motor",
                riskLevel: "MEDIUM",
                affectedKm: "Şehir İçi",
                repairCost: "Rejenerasyon / İptal"
            },
            {
                id: "egea-cross-16-2",
                title: "DCT Şanzıman Isınması",
                description: "Kuru kavramalı DCT şanzımanın yoğun trafikte ısınması ve silkelemesi.",
                category: "sanziman",
                riskLevel: "MEDIUM",
                affectedKm: "40.000+ km",
                repairCost: "Kavrama Değişimi"
            },
            {
                id: "egea-cross-16-3",
                title: "AdBlue Sistemi Arızası",
                description: "AdBlue pompa veya enjektör arızası (Motoru çalıştırmaz).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "30.000+ km",
                repairCost: "15.000 - 25.000 TL"
            },
            {
                id: "egea-cross-16-4",
                title: "Turbo Arızası",
                description: "Yüksek kilometrede veya kötü yağ kullanımında turbo mili boşluğu.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "100.000+ km",
                repairCost: "25.000 - 40.000 TL"
            },
            {
                id: "egea-cross-16-5",
                title: "Start-Stop Arızası",
                description: "Akü voltajı düştüğünde sistemin 'Devre Dışı' uyarısı vermesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Akü Şarjı / Değişimi"
        ...
        pros: [
            "Güçlü motor (320 Nm tork)",
            "Ekonomik yakıt",
            "Yerden yüksek yapı"
        ],
        cons: [
            "AdBlue maliyeti",
            "Şanzıman kararsızlığı"
        ],
        buyingTips: [
            "DCT şanzıman geçişlerini kontrol edin",
            "AdBlue deposu dolu mu?"
        ]
    },
    {
        id: "citroen-c3-aircross-1-2-puretech",
        ...
        issues: [
            {
                id: "c3-aircross-1",
                title: "Triger Kayışı Ufalanması (Wet Belt)",
                description: "Yağ içinde çalışan triger kayışının zamanla parçalanarak yağ pompasını tıkaması ve motoru kitlemesi (Kritik).",
                category: "motor",
                riskLevel: "CRITICAL",
                affectedKm: "40.000+ km / 4 Yıl",
                repairCost: "40.000 - 70.000 TL (Sandık Motor)"
            },
            {
                id: "c3-aircross-2",
                title: "Aşırı Yağ Tüketimi",
                description: "Piston segmanlarının aşınması veya kurum bağlaması sonucu motorun yağ yakması.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "60.000+ km",
                repairCost: "Motor Yenileme"
            },
            {
                id: "c3-aircross-3",
                title: "Multimedya Donması",
                description: "Ekranın siyah olması veya dokunmatiğin tepki vermemesi.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım / Ekran Değişimi"
            ...
            {
                id: "c3-aircross-4",
                title: "Buji Kırılması",
                description: "Ateşleme sistemi kaynaklı buji porseleninin kırılıp silindire düşme riski.",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "30.000 - 40.000 km",
                repairCost: "Motor Revizyonu"
            },
            {
                id: "c3-aircross-5",
                title: "Amortisör Takoz Sesi",
                description: "Ön takımdan gelen lakırtı sesleri.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Boşluklu Yollar",
                repairCost: "3.000 - 5.000 TL"
            }
        ],
        pros: [
        ...
        buyingTips: [
            "Triger kayışı değişmiş mi? (Fatura isteyin)",
            "Yağ kapağını açıp kayışın durumuna bakın (Çatlak/Şişme)"
        ]
    },
    {
        id: "citroen-c4-x-1-2-puretech",
        ...
        issues: [
            {
                id: "c4x-1",
                title: "Triger Kayışı Ufalanması (Wet Belt)",
                description: "Yağ içinde çalışan triger kayışının parçalanarak motoru tıkaması (Kritik).",
                category: "motor",
                riskLevel: "CRITICAL",
                affectedKm: "40.000+ km / 4 Yıl",
                repairCost: "40.000 - 70.000 TL"
            },
            {
                id: "c4x-2",
                title: "Benzin Kaçağı (Recall)",
                description: "Yüksek basınçlı yakıt borusunda sızıntı ve yangın riski (Geri çağırma kapsamında).",
                category: "motor",
                riskLevel: "HIGH",
                affectedKm: "2023-2025 Modeller",
                repairCost: "Ücretsiz (Servis)"
            },
            {
                id: "c4x-3",
                title: "Multimedya Hataları",
                description: "Ekranın donması, kararması veya geri görüş kamerasının çalışmaması.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            },
            {
                id: "c4x-4",
                title: "Şanzıman Kararsızlığı",
                description: "Düşük hızlarda vites geçişlerinde sarsıntı veya kararsızlık.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Şehir İçi",
                repairCost: "Yazılım"
            },
            {
                id: "c4x-5",
                title: "Ön Takım Sesleri",
                description: "Süspansiyon sisteminden gelen lokurtu sesleri.",
                category: "suspansiyon",
                riskLevel: "LOW",
                affectedKm: "Bozuk Yollar",
                repairCost: "Burç Değişimi"
            }
        ],
        pros: [
            "Konfor (Advanced Comfort)",
        ...
        buyingTips: [
            "Triger kayışını mutlaka kontrol ettirin",
            "Geri çağırma (Recall) işlemleri yapılmış mı?"
        ]
    },
    {
    ...
    },
    {
        ...
        issues: [
            ...
            },
            {
                id: "tiggo7-2",
                title: "Multimedya Donması",
                description: "Ekranın kilitlenmesi, siyah ekran vermesi ve CarPlay kopmaları.",
                category: "elektronik",
                riskLevel: "LOW",
                affectedKm: "Rastgele",
                repairCost: "Yazılım"
            },
            {
                id: "tiggo7-3",
                title: "DCT Şanzıman Isınması",
                description: "Yoğun trafikte şanzıman ısınması ve vites kararsızlığı.",
                category: "sanziman",
                riskLevel: "LOW",
                affectedKm: "Şehir İçi",
                repairCost: "Soğutma"
            },
            {
                id: "tiggo7-4",
                title: "Trim Sesleri",
                description: "Bozuk yollarda B sütunu ve ön konsoldan gelen tıkırtı sesleri.",
                category: "govde",
                riskLevel: "LOW",
                affectedKm: "Zamanla",
                repairCost: "Yalıtım"
            },
            {
                id: "tiggo7-5",
                title: "Klima Performansı",
                description: "Klimanın soğutma performansının yetersiz kalması (Yazılımsal).",
                category: "motor",
                riskLevel: "LOW",
                affectedKm: "Yaz Ayları",
                repairCost: "Yazılım Güncelleme"
        ...
        cons: [
            "Yakıt tüketimi",
            "İkinci el belirsizliği",
            "Servis yoğunluğu"
        ],
        buyingTips: [
            "Yakıt tüketimini kabul ederek alın",
            "Ekranı ve kameraları test edin"
        ]
    }
];

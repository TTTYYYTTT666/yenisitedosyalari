            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {favCars.length === 0 ? (
                    <div className="bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-800 p-12 text-center">
                        <svg className="w-12 h-12 mx-auto mb-4 text-stone-300 dark:text-stone-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p className="text-sm text-stone-500 dark:text-stone-400 mb-6">
                            Arac sayfalarinda kaydet butonuna tiklayarak favorilerinize ekleyebilirsiniz.
                        </p>
                        <Link
                            href="/"

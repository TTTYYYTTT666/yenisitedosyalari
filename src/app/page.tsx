  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-[#0c0a09]">
      ...
      <section className="relative overflow-hidden pt-24 pb-16 lg:pt-36 lg:pb-24">
        {/* Subtle background */}
        <div className="absolute inset-0 bg-stone-900 dark:bg-[#0c0a09]" />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-stone-800 border border-stone-700 rounded-md text-stone-400 text-xs font-medium mb-6 tracking-wide uppercase">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-white leading-tight">
            Hangi aracı
            <br />
            <span className="text-orange-500">almayı düşünüyorsunuz?</span>
          </h1>

          <p className="text-base md:text-lg text-stone-400 max-w-xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
            {[
              ...
              <div key={i} className="py-3 px-4 rounded-lg bg-stone-800/60 border border-stone-700/50">
      ...
      {/* Features Section */}
      <section className="py-16 lg:py-20 bg-stone-50 dark:bg-[#0c0a09] border-t border-stone-200 dark:border-stone-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {/* Feature 1 */}
            <div className="p-6 rounded-xl bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 hover:border-orange-300 dark:hover:border-orange-800 transition-colors">
              <div className="w-10 h-10 bg-red-50 dark:bg-red-950/30 rounded-lg flex items-center justify-center mb-4">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-stone-900 dark:bg-stone-950 border-t border-stone-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="/markalar"
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-orange-600 text-white text-sm font-semibold rounded-lg hover:bg-orange-700 transition-colors"
          >
            Markalara Göz At

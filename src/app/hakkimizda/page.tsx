            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-base text-stone-500">
                        OTORAPORU.NET, araç alım sürecinizi şeffaflaştırmak ve güvenli hale getirmek için burada.
                    </p>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <section className="bg-stone-900 text-white rounded-xl p-6 md:p-8 text-center">
                        ...
                        <a href="mailto:iletisim@otoraporu.net" className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-stone-900 text-sm font-semibold rounded-lg hover:bg-orange-50 transition-colors">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            iletisim@otoraporu.net
                        </a>
                    </section>
                </div>
            </div>
